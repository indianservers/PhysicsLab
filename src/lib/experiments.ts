...
const gapFillSchoolExperiments: ExperimentDefinition[] = [
  ...
  },
  {
    ...
    theory: "The eye lens changes focal length to focus images on the retina. Diverging or converging corrective lenses shift the focus back to the retina.",
    apparatus: ["Eye model", "Retina screen", "Concave lens", "Convex lens"],
    ...
    procedure: ["Choose eye defect.", "Set eye focal length.", "Add corrective lens power.", "Check whether the image falls on the retina."],
    ...
    expectedResult: "Myopia is corrected by a concave lens; hypermetropia is corrected by a convex lens.",
    vivaQuestions: [{ prompt: "Which lens corrects myopia?", answer: "A concave or diverging lens." }],
