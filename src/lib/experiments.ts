...
const phase2SchoolExperiments: ExperimentDefinition[] = [
  {
    ...
    formulae: [{ id: "temp-conversion", name: "Temperature conversion", expression: "K = ^\\circ C + 273.15", variables: [{ symbol: "K", name: "Kelvin temperature", unit: "K" }] }],
  ...
  },
  {
    ...
    aim: "Visualize deviation and dispersion of white light through a prism.",
    theory: "Different wavelengths refract by slightly different amounts, separating white light into a spectrum.",
    apparatus: ["White light ray", "Prism", "Screen"],
    formulae: [{ id: "prism-deviation", name: "Approximate deviation", expression: "\\delta \\approx (n-1)A", variables: [{ symbol: "A", name: "Prism angle", unit: "degree" }] }],
    procedure: ["Set prism angle.", "Change refractive index.", "Increase dispersion factor.", "Compare mean deviation and colour spread."],
    simulationSetup: { gravity: 9.81, objects: [{ ...createObject("light-ray", 220, 300), wavelength: 0 }, createObject("prism", 500, 300)] },
    observationColumns: ["Prism angle", "Mean refractive index", "Deviation", "Spread"],
    expectedResult: "Larger prism angle and stronger dispersion create a wider visible spectrum.",
    vivaQuestions: [{ prompt: "Which colour deviates more in normal glass?", answer: "Violet deviates more than red." }],
    commonMistakes: ["Thinking all colours refract equally", "Confusing deviation with dispersion"],
  },
  {
    id: "ohms-law",
...
const phase3SeniorExperiments: ExperimentDefinition[] = [
  ...
  seniorExperiment({
    ...
    procedure: ["Set resistance.", "Set frequency.", "Set L/C factor.", "Observe impedance and current."],
    ...
    observationColumns: ["R", "Frequency", "Reactance gap", "Impedance", "Current"],
