...
const expansionExperiments: ExperimentDefinition[] = [
  {
    id: "balancing-act", title: "Balancing Act", category: "Mechanics", difficulty: "Beginner", classLevel: "Class 8 / Class 11",
    curriculumTags: { classes: [8, 11], unitIds: ["c11-mechanics-core"], topicIds: ["c11-rotational-motion"], domains: ["Mechanics"] },
    aim: "Balance a beam by changing mass and lever-arm distance, then explain rotational equilibrium.", theory: "A rigid body is in rotational equilibrium when clockwise and anticlockwise torques cancel.", apparatus: ["Beam", "Pivot", "Masses", "Distance scale"],
    ...
    procedure: ["Predict which side falls.", "Change one mass or distance.", "Find the balance point.", "Record two different balanced arrangements."], simulationSetup: { gravity: 9.81, objects: [createObject("rod", 460, 300), createObject("block", 260, 220), createObject("block", 650, 220)] }, observationColumns: ["Left mass", "Left distance", "Right mass", "Balance distance", "Outcome"], expectedResult: "The beam balances when opposing moments are equal.", vivaQuestions: [{ prompt: "Can unequal masses balance?", answer: "Yes, if their lever arms make the opposing torques equal." }], commonMistakes: ["Comparing masses without distances", "Measuring from the beam end instead of the pivot"],
  },
  {
    id: "blackbody-spectrum", title: "Blackbody Spectrum", category: "Thermodynamics", difficulty: "Intermediate", classLevel: "Class 11 / Undergraduate",
    ...
    aim: "Relate an ideal emitter's temperature to its spectral peak and total radiant power.", theory: "An ideal blackbody has a continuous thermal spectrum whose peak moves to shorter wavelength as temperature rises.", apparatus: ["Ideal radiator", "Spectrometer", "Temperature control", "Power meter"], formulae: [{ id: "wiens-law", name: "Wien displacement law", expression: "\\lambda_{max}T=2.898\\times10^{-3}\\,mK", variables: [{ symbol: "T", name: "Absolute temperature", unit: "K" }] }], procedure: ["Set a temperature.", "Locate the peak wavelength.", "Double temperature where possible.", "Compare radiated power."], simulationSetup: { gravity: 9.81, objects: [createObject("thermometer", 280, 280), createObject("graph-plotter", 540, 300)] }, observationColumns: ["Temperature", "Peak wavelength", "Exitance", "Colour trend"], expectedResult: "Higher temperature shifts the peak shorter and increases power strongly.", vivaQuestions: [{ prompt: "Why must temperature be in kelvin?", answer: "Thermal-radiation laws use absolute temperature." }], commonMistakes: ["Using Celsius in T to the fourth", "Treating perceived colour as a single emitted wavelength"],
  },
  {
    id: "build-a-nucleus", title: "Build a Nucleus", category: "Modern Physics", difficulty: "Intermediate", classLevel: "Class 12 / Undergraduate",
    ...
    aim: "Construct nuclei from protons and neutrons and compare mass number, neutron ratio, and binding-energy trends.", theory: "Nuclear stability reflects a competition between short-range nuclear attraction, proton repulsion, asymmetry, and pairing effects.", apparatus: ["Protons", "Neutrons", "Nuclide readout", "Binding estimator"], formulae: [{ id: "mass-number", name: "Mass number", expression: "A=Z+N", variables: [{ symbol: "Z", name: "Proton number", unit: "" }, { symbol: "N", name: "Neutron number", unit: "" }] }], procedure: ["Choose proton number.", "Add or remove neutrons.", "Compare N/Z with the stability band.", "Inspect binding energy per nucleon."], simulationSetup: { gravity: 9.81, objects: [createObject("charge", 400, 280)] }, observationColumns: ["Z", "N", "A", "N/Z", "Binding estimate"], expectedResult: "Light stable nuclei tend toward N approximately Z, while heavier stable nuclei require more neutrons.", vivaQuestions: [{ prompt: "What identifies an element?", answer: "Its proton number Z." }], commonMistakes: ["Confusing mass number with atomic mass", "Treating the semi-empirical estimate as an exact isotope table"],
  },
  {
    id: "color-vision", title: "Color Vision", category: "Optics", difficulty: "Beginner", classLevel: "Class 8 / Class 12",
    ...
    aim: "Mix red, green, and blue light and connect additive colour to cone responses.", theory: "Human colour vision compares overlapping responses from three cone classes; displays stimulate them with additive RGB light.", apparatus: ["Red source", "Green source", "Blue source", "Projection screen"], formulae: [], procedure: ["Predict the mixture.", "Raise one channel at a time.", "Create white and secondary colours.", "Compare brightness with hue."], simulationSetup: { gravity: 9.81, objects: [createObject("light-ray", 300, 250)] }, observationColumns: ["Red", "Green", "Blue", "Perceived colour", "Luminance"], expectedResult: "Equal strong RGB signals appear white; pairwise mixtures form cyan, magenta, and yellow.", vivaQuestions: [{ prompt: "Why is light mixing additive?", answer: "Each source adds photons and cone stimulation." }], commonMistakes: ["Applying paint-mixing rules to light", "Assuming wavelength maps one-to-one to every perceived colour"],
  },
  {
    id: "fourier-making-waves", title: "Fourier: Making Waves", category: "Waves", difficulty: "Intermediate", classLevel: "Class 11 / Undergraduate",
    ...
    aim: "Synthesize a waveform from harmonics and identify its component frequencies.", theory: "Periodic signals can be represented as sums of sine and cosine components at integer multiples of a fundamental frequency.", apparatus: ["Oscillators", "Harmonic mixer", "Waveform display", "Spectrum readout"], formulae: [{ id: "fourier-series", name: "Harmonic sum", expression: "y(t)=\\sum_n A_n\\sin(n\\omega_0t+\\phi_n)", variables: [{ symbol: "A_n", name: "Harmonic amplitude", unit: "" }] }], procedure: ["Start with the fundamental.", "Add the second harmonic.", "Add the third harmonic.", "Relate waveform features to the spectrum."], simulationSetup: { gravity: 9.81, objects: [createObject("wave-source", 300, 280), createObject("graph-plotter", 580, 300)] }, observationColumns: ["A1", "A2", "A3", "RMS amplitude", "Waveform"], expectedResult: "Harmonics reshape the signal through linear superposition.", vivaQuestions: [{ prompt: "Does adding harmonics change the fundamental frequency?", answer: "No; it changes the waveform while the fundamental remains." }], commonMistakes: ["Adding intensities instead of signed displacements", "Confusing harmonic number with amplitude"],
  },
  {
    id: "resistance-in-a-wire", title: "Resistance in a Wire", category: "Electricity", difficulty: "Beginner", classLevel: "Class 10 / Class 12",
    ...
    aim: "Investigate how resistivity, wire length, and cross-sectional area determine resistance.", theory: "For a uniform ohmic wire at fixed temperature, resistance is proportional to length and inversely proportional to area.", apparatus: ["Test wire", "Length scale", "Diameter gauge", "Ohmmeter"], formulae: [{ id: "wire-resistance", name: "Resistivity relation", expression: "R=\\rho L/A", variables: [{ symbol: "rho", name: "Resistivity", unit: "ohm m" }, { symbol: "L", name: "Length", unit: "m" }, { symbol: "A", name: "Area", unit: "m^2" }] }], procedure: ["Set resistivity.", "Double wire length.", "Double cross-sectional area.", "Compare resistance and current."], simulationSetup: { gravity: 9.81, objects: [createObject("wire", 420, 280), createObject("voltmeter", 650, 300)] }, observationColumns: ["Resistivity", "Length", "Area", "Resistance", "Current"], expectedResult: "Resistance increases linearly with length and decreases inversely with area.", vivaQuestions: [{ prompt: "Why does a thicker wire have lower resistance?", answer: "It provides a larger cross-section for charge transport." }], commonMistakes: ["Using square millimetres as square metres", "Changing temperature while treating resistivity as fixed"],
  },
  {
    id: "rutherford-scattering", title: "Rutherford Scattering", category: "Modern Physics", difficulty: "Advanced", classLevel: "Class 12 / Undergraduate",
    ...
    aim: "Scatter alpha particles from a nucleus and connect rare large deflections to concentrated positive charge.", theory: "Coulomb repulsion bends alpha-particle trajectories; small impact parameters produce the largest scattering angles.", apparatus: ["Alpha source", "Thin target", "Detector", "Impact-parameter control"], formulae: [{ id: "rutherford-angle", name: "Coulomb scattering angle", expression: "\\theta=2\\tan^{-1}(kZ_1Z_2e^2/2Eb)", variables: [{ symbol: "E", name: "Kinetic energy", unit: "MeV" }, { symbol: "b", name: "Impact parameter", unit: "fm" }] }], procedure: ["Set target charge.", "Launch at a large impact parameter.", "Move closer to the nucleus.", "Increase energy and compare deflection."], simulationSetup: { gravity: 0, objects: [createObject("charge", 460, 300), createObject("graph-plotter", 680, 300)] }, observationColumns: ["Energy", "Impact parameter", "Z", "Angle", "Outcome"], expectedResult: "Deflection rises with nuclear charge and falls with energy and impact parameter.", vivaQuestions: [{ prompt: "What did rare backscattering show?", answer: "Positive charge and most atomic mass occupy a very small nucleus." }], commonMistakes: ["Drawing collisions with a nucleus of atomic size", "Including gravity in the particle path"],
  },
  {
    id: "states-of-matter", title: "States of Matter", category: "Thermodynamics", difficulty: "Beginner", classLevel: "Class 6 / Class 11",
    curriculumTags: { classes: [6, 9, 11], unitIds: ["c11-matter-thermal-waves"], topicIds: ["c11-thermal"], domains: ["Thermodynamics"] },
    aim: "Connect particle motion and attraction to solid, liquid, and gas behaviour.", theory: "A phase reflects the competition between thermal motion, intermolecular attraction, and pressure.", apparatus: ["Particle chamber", "Heater", "Pressure control", "Thermometer"], formulae: [{ id: "thermal-energy", name: "Thermal energy scale", expression: "E\\sim k_BT", variables: [{ symbol: "T", name: "Absolute temperature", unit: "K" }] }], procedure: ["Begin in Basic mode with temperature only.", "Heat through each modeled phase.", "Change pressure.", "Increase attraction and compare transition points."], simulationSetup: { gravity: 9.81, objects: [createObject("gas-container", 440, 300), createObject("thermometer", 250, 260)] }, observationColumns: ["Temperature", "Pressure", "Attraction", "Phase", "Particle pattern"], expectedResult: "Heating generally drives solid to liquid to gas, while pressure and stronger attraction favour condensed phases.", vivaQuestions: [{ prompt: "Do particles stop moving in a solid?", answer: "No; they vibrate about relatively fixed positions." }], commonMistakes: ["Treating the model transition temperatures as a specific real substance", "Drawing gas particles larger than solid particles"],
  },
  {
    id: "atomic-interactions", title: "Atomic Interactions", category: "Modern Physics", difficulty: "Intermediate", classLevel: "Class 11 / Undergraduate",
    ...
    aim: "Explore attractive and repulsive forces between neutral atoms using a Lennard-Jones model.", theory: "Longer-range dispersion attraction and steep short-range electron-cloud repulsion create an equilibrium separation.", apparatus: ["Atom pair", "Separation control", "Force meter", "Potential graph"], formulae: [{ id: "lennard-jones", name: "Lennard-Jones potential", expression: "U(r)=4\\epsilon[(\\sigma/r)^{12}-(\\sigma/r)^6]", variables: [{ symbol: "r", name: "Separation", unit: "angstrom" }] }], procedure: ["Begin far apart.", "Reduce separation.", "Locate minimum potential.", "Move closer and observe repulsion."], simulationSetup: { gravity: 0, objects: [createObject("charge", 320, 300), createObject("charge", 580, 300)] }, observationColumns: ["Distance", "Atomic size", "Well depth", "Potential", "Force"], expectedResult: "The force is attractive beyond equilibrium and strongly repulsive inside it.", vivaQuestions: [{ prompt: "Why is the force steeply repulsive at short range?", answer: "Overlapping electron clouds are energetically unfavorable, represented here by a steep model term." }], commonMistakes: ["Interpreting the atoms as permanently charged", "Using the model at nuclear distances"],
  },
  {
    id: "diffusion", title: "Diffusion", category: "Thermodynamics", difficulty: "Beginner", classLevel: "Class 9 / Undergraduate",
    ...
    aim: "Observe random particle motion producing a predictable ensemble spread.", theory: "Unbiased microscopic steps produce macroscopic diffusion, whose one-dimensional RMS displacement grows as the square root of time.", apparatus: ["Particle chamber", "Clock", "Temperature control", "Spread ruler"], formulae: [{ id: "diffusion-rms", name: "RMS diffusion distance", expression: "x_{rms}=\\sqrt{2Dt}", variables: [{ symbol: "D", name: "Diffusion coefficient", unit: "m^2/s" }, { symbol: "t", name: "Time", unit: "s" }] }], procedure: ["Start with a compact cloud.", "Advance time.", "Raise temperature.", "Compare light and heavy particles."], simulationSetup: { gravity: 0, objects: [createObject("gas-container", 430, 300), createObject("stopwatch", 230, 250)] }, observationColumns: ["Time", "Temperature", "Mass", "D", "RMS spread"], expectedResult: "The cloud spreads with square root of time and more rapidly for the modeled hotter, lighter particles.", vivaQuestions: [{ prompt: "Does diffusion require a preferred direction?", answer: "No; random motion spreads a concentration gradient without directed individual paths." }], commonMistakes: ["Expecting RMS distance to grow linearly with time", "Confusing individual motion with ensemble-average behaviour"],
  },
  {
    id: "greenhouse-effect", title: "Greenhouse Effect", category: "Thermodynamics", difficulty: "Intermediate", classLevel: "Class 9 / Class 11",
    curriculumTags: { classes: [9, 11], unitIds: ["c11-matter-thermal-waves"], topicIds: ["c11-thermal-radiation"], domains: ["Thermodynamics"] },
    aim: "Use a planetary energy-balance model to separate albedo from infrared absorption.", theory: "A planet warms until absorbed solar power balances outgoing infrared power; an infrared-absorbing layer changes the level from which energy escapes.", apparatus: ["Star", "Planet", "Atmospheric layer", "Radiation meters"], formulae: [{ id: "planet-balance", name: "One-layer balance", expression: "T=[S(1-\\alpha)/(4\\sigma(1-\\epsilon/2))]^{1/4}", variables: [{ symbol: "alpha", name: "Albedo", unit: "" }, { symbol: "epsilon", name: "Infrared absorption", unit: "" }] }], procedure: ["Set solar flux.", "Change albedo only.", "Change infrared absorption only.", "Compare equilibrium temperatures."], simulationSetup: { gravity: 9.81, objects: [createObject("thermometer", 520, 300), createObject("light-ray", 270, 230)] }, observationColumns: ["Solar flux", "Albedo", "IR absorption", "Absorbed flux", "Temperature"], expectedResult: "More reflection cools the model planet; stronger infrared absorption warms its surface in the one-layer model.", vivaQuestions: [{ prompt: "Do greenhouse gases mainly block visible sunlight?", answer: "No; the central effect is selective absorption and emission of infrared radiation." }], commonMistakes: ["Calling the greenhouse effect the same as ozone depletion", "Treating the one-layer result as a full climate forecast"],
  },
  {
    id: "molecules-and-light", title: "Molecules and Light", category: "Modern Physics", difficulty: "Intermediate", classLevel: "Class 11 / Undergraduate",
    ...
    aim: "Tune photon wavelength through a molecular transition and measure selective absorption.", theory: "Molecules exchange photons at allowed rotational, vibrational, or electronic energy differences, producing characteristic spectra.", apparatus: ["Tunable source", "Molecular sample", "Detector", "Spectrum display"], formulae: [{ id: "photon-energy", name: "Photon energy", expression: "E=hc/\\lambda", variables: [{ symbol: "lambda", name: "Wavelength", unit: "m" }] }], procedure: ["Set the transition wavelength.", "Sweep the source wavelength.", "Locate maximum absorption.", "Change intensity and distinguish peak position from strength."], simulationSetup: { gravity: 0, objects: [createObject("light-ray", 260, 280), createObject("graph-plotter", 620, 300)] }, observationColumns: ["Wavelength", "Photon energy", "Transition", "Intensity", "Absorbed"], expectedResult: "Absorption peaks when photon energy matches the modeled molecular transition.", vivaQuestions: [{ prompt: "Does brighter light shift an ideal transition wavelength?", answer: "No; it changes event rate, while the energy spacing sets the wavelength." }], commonMistakes: ["Assuming all wavelengths are absorbed equally", "Confusing intensity with photon energy"],
  },
];
