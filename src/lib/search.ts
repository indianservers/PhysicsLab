...
const index: SearchRecord[] = [
  ...[
    ...
    { id: "action-formula-revision-grid", title: "Open formula revision grid", subtitle: "Action - Categorized formula cards", path: "/formulas/revision-grid", icon: "calculator" as const, tags: ["formula", "equation", "revision", "grid", "categories", "constants"] },
