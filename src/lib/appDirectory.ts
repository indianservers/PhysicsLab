...
const platform: Array<Omit<DirectoryEntry, "section">> = [
  ...
  ["quiz","Quiz","Conceptual and numerical assessment.","/quiz","Practice","check"], ["graphs","Graph Studio","Interactive physics plots.","/graphs","Analysis","chart"],
  ...
  ["comparison","Platform Comparison","Product benchmark and positioning.","/comparison","Governance","chart"], ["settings","Settings","Application preferences.","/settings","Workspace","settings"],
