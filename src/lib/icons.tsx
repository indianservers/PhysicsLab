...
export function iconForExperiment(experiment: ExperimentDefinition): PhysicsIconName {
  ...
  if (id.includes("wave") || id.includes("sound") || id.includes("echo") || id.includes("slit")) return "wave";
  if (id.includes("mirror") || id.includes("lens") || id.includes("prism") || id.includes("refraction")) return id.includes("prism") ? "prism" : "eye";
  if (id.includes("ohm") || id.includes("circuit") || id.includes("current") || id.includes("capacitor") || id.includes("diode") || id.includes("power")) return "battery";
  ...
  if (id.includes("photoelectric") || id.includes("nuclear") || id.includes("bohr")) return "atom";
