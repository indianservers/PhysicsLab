...
export const astrophysicsConcepts: AstroConcept[] = [
  ...
  concept("distance-ladder", "Cosmic Distance Ladder", "Observation", "ruler", "Linked methods for measuring astronomical distances.", "Nearby parallax measurements calibrate standard candles, which then calibrate farther distance methods.", ["parallax", "Cepheids", "supernovae"], "m - M = 5 log10(d_pc) - 5", "spectrum", "Observation", "Distance modulus uses distance in parsecs.", "There is no single ruler for all cosmic distances.", "Order parallax, Cepheids, Type Ia supernovae, and Hubble law."),
