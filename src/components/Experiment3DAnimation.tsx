...
const animationConfigs: Record<string, AnimationConfig> = {
  "projectile-motion": {
    kind: "projectile",
    title: "Cinematic projectile motion",
    cue: "Watch launch velocity split into horizontal and vertical components, then track the ball, shadow, peak, and range in one scene.",
    cinematic: true,
    steps: [
  ...
  "vector-resolution": {
    kind: "vector3d",
    title: "3D vector decomposition",
    cue: "The resultant vector is projected onto coordinate axes so components reconstruct the original vector.",
    cinematic: true,
    steps: [
  ...
  "universal-gravitation": {
    kind: "gravity",
    title: "3D gravity field map",
    cue: "A test mass orbits through nested field shells while the attraction arrow shrinks with distance squared.",
    cinematic: true,
    steps: [
      "Increase source mass",
      "Move the test mass away",
  ...
  "density-float-sink": {
    kind: "densityTank",
    title: "3D float-or-sink tank",
    cue: "The block settles to a depth set by density ratio, making floating, neutral buoyancy, and sinking easy to compare.",
    steps: [
      "Compare densities",
      "Watch submerged fraction",
  ...
  "bernoulli-fluid-flow": {
    ...
    cue: "Flow speeds up through the narrow throat while static pressure gauges drop, showing the pressure-speed tradeoff.",
    cinematic: true,
    steps: [
      "Compare wide and narrow area",
  ...
  "thermodynamic-process": {
    kind: "thermoProcess",
    title: "3D thermodynamic process piston",
    cue: "A gas piston, heat arrows, pressure gauge, and compact P-V path show how process type changes work and heat exchange.",
    cinematic: true,
    steps: [
      "Choose process type",
      "Watch piston and heat exchange",
      "Compare work on the P-V path",
    ],
  },
  "calorimetry-mixing": {
    kind: "calorimetry",
    title: "3D calorimetry mixing",
    cue: "Hot and cold streams merge inside an insulated cup; the thermometer climbs toward the heat-balance temperature.",
    cinematic: true,
    steps: ["Pour hot sample", "Add cold sample", "Reach thermal equilibrium"],
  },
  "statistical-ensemble-lab": {
    kind: "statisticalEnsemble",
    title: "3D ensemble distribution",
    cue: "Particles occupy a state-space box while a histogram wall shows the mean and spread of the ensemble.",
    cinematic: true,
    steps: [
      "Sample many microstates",
      "Watch spread change",
      "Read ensemble mean",
    ],
  },
  ...
  "static-electricity": {
    ...
    cue: "Charged bodies exchange charge, then attract or repel with visible field lines and force arrows.",
    cinematic: true,
    steps: ["Charge by contact", "Compare signs", "Watch force and spark cue"],
  },
  "chemical-effects-current": {
    kind: "electrolysis",
    title: "3D electrolysis cell",
  ...
  "electrostatic-field-potential": {
    ...
    title: "3D field and potential map",
    cue: "Point charges create field arrows and potential-height rings; a test charge feels force along the field.",
    cinematic: true,
    steps: ["Place source charge", "Read field", "Compare potential"],
  },
  "kirchhoff-circuit": {
    kind: "kirchhoff3d",
    title: "3D Kirchhoff circuit board",
    cue: "Junction nodes split current across loop branches while KCL and KVL labels stay tied to the board.",
    cinematic: true,
    steps: ["Trace incoming current", "Split at junction", "Check loop drops"],
  },
  "ac-lcr-resonance": {
    kind: "lcr3d",
    title: "3D LCR resonance lab",
    cue: "R, L, and C sit in series with an AC source, phasor wheel, oscilloscope, and resonance curve marker.",
    cinematic: true,
    steps: ["Set frequency", "Compare reactances", "Find peak current"],
  },
  "meter-bridge": {
    kind: "meterBridge",
    title: "3D meter bridge board",
    cue: "A jockey probe moves along the one-meter wire until the galvanometer needle reaches null.",
    cinematic: true,
    steps: ["Set ratio", "Move jockey", "Find null"],
  },
  "internal-resistance-cell": {
    kind: "internalCell",
    title: "3D internal resistance cell",
    cue: "The cell separates EMF from terminal voltage and shows internal voltage drop as load current rises.",
    cinematic: true,
    steps: ["Set load", "Watch internal drop", "Compare E and V"],
  },
  electromagnet: {
    kind: "electromagnet",
  ...
  "lorentz-force": {
    kind: "lorentz3d",
    title: "3D Lorentz force lab",
    cue: "A charged particle enters a uniform magnetic field; velocity, field, and force vectors reveal q(v x B), with negative charge reversing the bend.",
    cinematic: true,
    steps: [
      "Set charge sign",
      "Enter uniform B field",
      "Read force and radius",
    ],
  },
  "emi-faraday": {
    kind: "induction",
    title: "Cinematic Faraday induction",
    cue: "Flux ribbons pass through the coil, the magnet moves, and the galvanometer responds when flux changes quickly.",
    cinematic: true,
    steps: ["Move magnet", "Change magnetic flux", "Induce emf and current"],
  },
  "ac-generator": {
    kind: "generator",
    title: "Cinematic AC generator",
    cue: "The rotating coil cuts magnetic flux; slip rings feed brushes while the waveform grows and reverses in sync.",
    cinematic: true,
    steps: [
      "Rotate coil in field",
      "Flux changes continuously",
      "Output becomes AC sine wave",
    ],
  },
  "transformer-lab": {
    kind: "transformer",
    title: "Cinematic transformer",
    cue: "Primary AC creates changing core flux, the secondary coil receives it, and the voltage bars compare the turns ratio.",
    cinematic: true,
    steps: [
      "Primary AC drives flux",
      "Core links both coils",
      "Turns ratio sets secondary voltage",
    ],
  },
  "lens-formula": {
    kind: "lens",
    title: "Cinematic lens bench",
    cue: "Object rays, focal planes, and image screen line up in 3D so the lens equation becomes a spatial story.",
    cinematic: true,
    steps: [
      "Send principal rays",
      "Bend through lens",
  ...
  "reflection-plane-mirror": {
    kind: "planeMirror3d",
    title: "3D plane mirror reflection",
    cue: "An object and its virtual image stay symmetric across the mirror while incident and reflected rays keep equal angles.",
    cinematic: true,
    steps: [
      "Set incidence angle",
      "Compare i and r",
      "Check equal object-image distance",
    ],
  },
  "glass-slab-refraction": {
    kind: "glassSlab3d",
    title: "3D glass slab refraction",
    cue: "The ray bends at both slab faces; the emergent ray remains parallel to the incident ray but is laterally shifted.",
    cinematic: true,
    steps: [
      "Enter first face",
      "Refract inside glass",
      "Exit parallel with lateral shift",
    ],
  },
  "shadows-eclipses": {
    kind: "shadowEclipse3d",
    title: "3D shadows and eclipses",
    cue: "A source, occluding body, and receiver line up so umbra and penumbra regions are visible in space.",
    cinematic: true,
    steps: [
      "Align source and body",
      "Trace full shadow",
      "Separate umbra from penumbra",
    ],
  },
  "multiple-reflection": {
    kind: "multipleReflection3d",
    title: "3D multiple reflection",
    cue: "Two ideal mirror panels form a V; smaller angles create more repeated virtual images and a kaleidoscope pattern.",
    cinematic: true,
    steps: [
      "Set mirror angle",
      "Place object between mirrors",
      "Count repeated images carefully",
    ],
  },
  "human-eye-defects": {
    kind: "eye",
    title: "3D realistic eye focus",
    cue: "Trace rays through the corrective lens, cornea, eye lens, and retina. Myopia focuses before the retina; hypermetropia focuses behind it.",
    cinematic: true,
    steps: [
      "Choose the defect",
      "Watch the uncorrected focus",
      "Add the correct lens type",
    ],
  },
  "prism-dispersion": {
    kind: "prism",
  ...
  "optical-instruments": {
    ...
    cue: "Objective and eyepiece lenses form an intermediate image, then send a final virtual image direction to the eye.",
    cinematic: true,
    steps: [
  ...
  "wave-lab": {
    kind: "waveLab3d",
    title: "3D wave lab",
    cue: "A string wave shows amplitude, wavelength, frequency, speed, and local medium motion separately from wave propagation.",
    cinematic: true,
    steps: [
      "Set amplitude and frequency",
      "Watch local particles oscillate",
      "Read v = f lambda",
    ],
  },
  "chladni-plate": {
    kind: "chladni3d",
    title: "3D Chladni plate",
    cue: "A vibrating plate forms mode-dependent nodal lines where sand collects while antinode regions move.",
    cinematic: true,
    steps: [
      "Set mode/frequency",
      "Find stationary nodes",
      "Compare sand accumulation",
    ],
  },
  "echo-speed-sound": {
    kind: "echo3d",
    title: "3D echo timing lab",
    cue: "A sound pulse travels to a reflecting wall and returns, making the factor of two in echo distance visible.",
    cinematic: true,
    steps: ["Send pulse", "Reflect at wall", "Use distance = v t / 2"],
  },
  "sound-pitch-loudness": {
    kind: "soundPitch3d",
    title: "3D pitch and loudness lab",
    cue: "The source vibration and pressure rings separate frequency as pitch from amplitude as loudness/intensity cue.",
    cinematic: true,
    steps: [
      "Change frequency",
      "Change amplitude",
      "Compare wavelength and loudness cue",
    ],
  },
  "shm-spring": {
    kind: "springShm3d",
    title: "3D spring-mass SHM",
    cue: "A mass oscillates about equilibrium with restoring force, velocity, amplitude limits, and energy exchange cues.",
    cinematic: true,
    steps: [
      "Displace the mass",
      "Watch F = -kx",
      "Compare kinetic and spring energy",
    ],
  },
  "em-spectrum": {
    kind: "spectrum3d",
    title: "3D electromagnetic spectrum",
    cue: "A spectrum wall shows radio through gamma regions with wavelength decreasing as frequency increases.",
    cinematic: true,
    steps: ["Move along spectrum", "Find visible band", "Compare c = f lambda"],
  },
  "polarization-lab": {
    kind: "polarization3d",
    title: "3D polarization and Malus law",
    cue: "Polarizer and analyzer planes show transmission axes, angle theta, and transmitted intensity from I = I0 cos^2 theta.",
    cinematic: true,
    steps: ["Set analyzer angle", "Compare axes", "Read transmitted intensity"],
  },
  "measurement-errors": {
    kind: "measurement3d",
    title: "3D measurement uncertainty bench",
    cue: "A measured object, instrument scale, repeated markers, mean, and uncertainty range separate precision from error.",
    cinematic: true,
    steps: [
      "Read the scale",
  ...
  "nuclear-decay": {
    kind: "nuclearDecay3d",
    title: "3D half-life decay population",
    cue: "A cluster of unstable nuclei changes state while a half-life ring and curve show statistical population decay.",
    cinematic: true,
    steps: ["Set half-life", "Watch decay events", "Read remaining nuclei"],
  },
  "semiconductor-diode": {
    kind: "diode3d",
    title: "3D PN junction and rectifier",
    cue: "P and N regions, depletion zone, carriers, I-V knee, and rectified waveform show forward and reverse bias behavior.",
    cinematic: true,
    steps: ["Set bias", "Watch depletion barrier", "Compare rectified output"],
  },
  "sources-of-energy": {
    kind: "energySources3d",
    title: "3D energy source comparison",
    cue: "Mini apparatus for solar, wind, hydro, fossil, and nuclear sources compare output, reliability, and emissions.",
    cinematic: true,
    steps: [
      "Select a source",
      "Compare output bars",
  ...
  "advanced-quantum-operators": {
    ...
    title: "3D quantum operator state space",
    cue: "A state vector, operator axis, eigenbasis, and measurement bars show qualitative operator action.",
    cinematic: true,
    steps: ["Set state", "Apply operator", "Read expectation"],
  },
  "computational-physics-workflow": {
    kind: "computationalWorkflow3d",
    title: "3D computational workflow",
    cue: "Problem, discretization, solver iterations, convergence, error estimate, and result panel form one numerical-method pipeline.",
    cinematic: true,
    steps: [
  ...
  "bohr-model": {
    ...
    cue: "Energy shells, electron jump path, photon pulse, and level ladder reveal why each spectral line has a fixed energy.",
    cinematic: true,
    steps: [
      "Choose energy levels",
      "Electron jumps shell",
      "Photon carries energy gap",
    ],
  },
  "chaotic-coupled-oscillators": {
    kind: "coupledOscillator",
    title: "3D coupled oscillator chaos",
    cue: "Two linked pendulum arms exchange energy. Increase the angle or coupling and the phase trail spreads instead of closing into a simple loop.",
    cinematic: true,
    steps: [
      "Set nearby initial angles",
      "Watch energy swap between arms",
      "Compare regular loops with chaotic phase spread",
    ],
  },
  "logic-gates": {
    kind: "logic",
    title: "3D logic gate",
    cue: "Inputs feed a digital gate and the output indicator switches between 0 and 1.",
  },
};
...
export function Experiment3DAnimation({
  ...
  timelineTime = null,
  fixedShell = false,
}: Experiment3DAnimationProps) {
  const visualizationSpec = getExperimentVisualizationSpec(experiment.id);
  const isPending3D =
    !visualizationSpec || isPanePending(visualizationSpec.threeD);
  ...
  const sendViewCommand = (
    ...
    mountRef.current?.dispatchEvent(
      new CustomEvent("three-view-command", { detail: command }),
    );
  };

  useEffect(() => {
    timelineTimeRef.current =
      typeof timelineTime === "number" ? timelineTime : null;
  }, [timelineTime]);
  ...
  useEffect(() => {
    ...
    try {
      ...
      fallback.innerHTML =
        "<strong>3D view needs WebGL.</strong><span>The guided animation and calculator still work in this browser.</span>";
    ...
    scene.fog = new THREE.Fog(
      0x020617,
      config.cinematic ? 9 : 8,
      config.cinematic ? 22 : 18,
    );
    const camera = new THREE.PerspectiveCamera(44, 1, 0.1, 100);
    const composer = config.cinematic ? new EffectComposer(renderer) : null;
    const bloomPass = config.cinematic
      ? new UnrealBloomPass(new THREE.Vector2(1, 1), 0.16, 0.28, 0.42)
      : null;
    const ssaoPass = config.cinematic
      ? new SSAOPass(scene, camera, 1, 1)
      : null;
    ...
    try {
      ...
      fallback.className = "three-lab-fallback";
      fallback.innerHTML =
        "<strong>3D scene could not render.</strong><span>The 2D visualization, sliders, graph, and calculator are still available for this lab.</span>";
      mount.replaceChildren(fallback);
      renderer.dispose();
      return undefined;
    }
    ...
    const onViewCommand = (event: Event) => {
      const command = (
        event as CustomEvent<"reset" | "front" | "top" | "zoom-in" | "zoom-out">
      ).detail;
      if (command === "reset") {
        orbit.theta = 0.58;
        orbit.phi = 1.18;
    ...
    return () => {
      ...
      scene.traverse((object) => {
        ...
        if (Array.isArray(material)) material.forEach((item) => item.dispose());
          ...
          const map = (
            material as THREE.MeshStandardMaterial | THREE.SpriteMaterial
          ).map;
          map?.dispose?.();
          material?.dispose?.();
        }
  ...
  const cardClassName = config.cinematic
    ? "three-lab-card three-lab-card-cinematic mt-5 fullscreen-target"
    : "three-lab-card mt-5 fullscreen-target";
  ...
  const header = (
    <div
      className={
        fixedShell
          ? "visual-disclosure-summary visual-disclosure-summary-fixed"
    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          className="three-view-icon-btn"
          type="button"
          onClick={(event) => {
            event.preventDefault();
            event.stopPropagation();
            sendViewCommand("zoom-in");
          }}
          title="Zoom in"
        >
          +
        ...
        <button
          ...
          onClick={(event) => {
            event.preventDefault();
            event.stopPropagation();
            sendViewCommand("zoom-out");
          }}
          title="Zoom out"
        >
          -
        </button>
        <span className="status-chip border-cyan-300/40 bg-cyan-300/10 text-cyan-100">
          {config.cinematic ? "cinematic explainer" : "responds to sliders"}
        </span>
      </div>
    </div>
  );
  const body = (
    ...
    <div
      className={
        config.cinematic
          ? "visual-disclosure-body mt-3 grid gap-3 xl:grid-cols-[minmax(0,1fr)_260px]"
          : "visual-disclosure-body mt-3 grid gap-3 lg:grid-cols-[minmax(0,1fr)_210px]"
      }
    >
      <div
        ref={mountRef}
        className={
          config.cinematic
            ? "three-lab-canvas three-lab-canvas-cinematic"
            : "three-lab-canvas"
        }
      >
      ...
      <div className="grid content-start gap-2">
          ...
          <div className="rounded-md border border-amber-300/25 bg-amber-300/10 p-3">
            ...
            <div className="mt-2 grid gap-2">
              {config.steps.map((step, index) => (
                ...
                >
                  <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-amber-300 text-[10px] font-black text-slate-950">
                    {index + 1}
                  </span>
                  <span>{step}</span>
                </div>
        ...
        {outputs.slice(0, 3).map((output) => (
          <div
            key={output.label}
            className="rounded-md border border-slate-700 bg-slate-950/75 p-2"
          >
            <div className="text-xs text-slate-400">{output.label}</div>
            <div className="mt-1 break-words font-mono text-sm font-black text-cyan-300">
              {output.value}
            </div>
          </div>
        ))}
  ...
  if (fixedShell) {
    return (
      <section
        ...
        aria-label={`${experiment.title} 3D animation`}
      >
        {header}
        {body}
      </section>
...
function buildScene(
  ...
  if (kind === "rotationalDynamics")
    return buildRotationalDynamics(root, a, b, c);
  ...
  if (kind === "statisticalEnsemble")
    return buildStatisticalEnsemble(root, a, b, c);
  if (kind === "circuit") return buildCircuit(root, a, b, c);
  if (kind === "staticElectricity")
    return buildStaticElectricity(root, a, b, c);
  if (kind === "electrostaticField")
    return buildElectrostaticField(root, a, b, c);
  ...
  if (kind === "multipleReflection3d")
    return buildMultipleReflection3D(root, a, b, c);
  if (kind === "opticalInstrument3d")
    return buildOpticalInstrument3D(root, a, b, c);
  ...
  if (kind === "quantumOperators3d")
    return buildQuantumOperators3D(root, a, b, c);
  if (kind === "computationalWorkflow3d")
    return buildComputationalWorkflow3D(root, a, b, c);
...
function paletteForKind(kind: AnimationKind) {
  if (
    ...
    return { primary: 0xf97316, secondary: 0x38bdf8, hot: 0xfacc15 };
  if (
    kind === "circuit" ||
    kind === "staticElectricity" ||
    kind === "electrostaticField" ||
    ...
    return { primary: 0x22d3ee, secondary: 0xfacc15, hot: 0xf97316 };
  if (
    kind === "lens" ||
    kind === "eye" ||
    kind === "prism" ||
    ...
    return { primary: 0x67e8f9, secondary: 0xa78bfa, hot: 0xfacc15 };
  if (kind === "gravity" || kind === "bohr" || kind === "photoelectric")
    return { primary: 0xa78bfa, secondary: 0x22d3ee, hot: 0xfacc15 };
  if (
    kind === "buoyancy" ||
    kind === "densityTank" ||
    kind === "fluid" ||
    ...
    return { primary: 0x38bdf8, secondary: 0x0ea5e9, hot: 0xa3e635 };
  if (
    kind === "force" ||
    kind === "forceBalance" ||
    kind === "incline" ||
    ...
    return { primary: 0x38bdf8, secondary: 0xf43f5e, hot: 0xfacc15 };
...
function buildProjectile(
  ...
  const range = clamp(
    (speed * speed * Math.sin(2 * theta)) / Math.max(1, gravity),
    2,
    12,
  );
  const height = clamp(
    (speed * speed * Math.sin(theta) ** 2) / (2 * Math.max(1, gravity)),
    1,
    5,
  );
  ...
  root.add(
    tube(
      points.map((point) => new THREE.Vector3(point.x, -1.05, point.z)),
      0.02,
      0x64748b,
      0.85,
    ),
  ...
  addArrow(
    root,
    launch,
    new THREE.Vector3(-2.1, -0.84 + Math.sin(theta) * 1.5, -0.98),
    0x38bdf8,
  );
  addArrow(
    root,
    launch.clone().add(new THREE.Vector3(0, 0.05, 0.12)),
    launch.clone().add(new THREE.Vector3(1.2, 0.05, 0.12)),
    0x34d399,
  );
  addArrow(
    root,
    launch.clone().add(new THREE.Vector3(0.1, 0, -0.18)),
    launch.clone().add(new THREE.Vector3(0.1, Math.sin(theta) * 1.25, -0.18)),
    0xfacc15,
  );
  ...
  root.add(
    label("vx constant", new THREE.Vector3(-2.55, -0.5, -1.0), 0x34d399),
  );
  root.add(
    label("vy changes", new THREE.Vector3(-3.15, 0.55, -1.45), 0xfacc15),
  );
  root.add(
    label("peak", peak.clone().add(new THREE.Vector3(0.15, 0.35, 0)), 0xfacc15),
  );
  root.add(
    label(
      `range ${range.toFixed(1)} m`,
      points[points.length - 1].clone().add(new THREE.Vector3(-0.55, 0.3, 0.1)),
      0x34d399,
    ),
  );
  addPlatform(root);
...
function buildGraph3D(
  ...
  addArrow(
    root,
    origin,
    origin.clone().add(new THREE.Vector3(2.65, 0, 0)),
    0x94a3b8,
  );
  addArrow(
    root,
    origin,
    origin.clone().add(new THREE.Vector3(0, 1.75, 0)),
    0x94a3b8,
  );
  const maxDistance = Math.max(
    1,
    startDistance + speed * Math.max(1, time),
    120,
  );
  ...
  const slopeArrowStart =
    graphPoints[Math.max(4, Math.floor(graphPoints.length * 0.35))];
  const slopeArrowEnd =
    graphPoints[
      Math.min(graphPoints.length - 1, Math.floor(graphPoints.length * 0.74))
    ];
  addArrow(
    root,
    slopeArrowStart,
    slopeArrowEnd,
    speed > 0 ? 0x34d399 : 0x64748b,
  );
  root.add(
    label("motion track", new THREE.Vector3(-2.25, -0.12, -0.95), 0x38bdf8),
  );
  root.add(
    label("slope = speed", new THREE.Vector3(-1.3, 1.15, 0.78), 0xfacc15),
  );
  root.add(
    label(
      speed === 0 ? "rest line" : "uniform motion",
      new THREE.Vector3(1.1, 0.58, 0.78),
      0x34d399,
    ),
  );
}
...
function buildForce(
  ...
  addArrow(
    ...
    new THREE.Vector3(clamp(force / Math.max(1, mass), 0.8, 2.6), -0.72, 0),
    0xf43f5e,
  );
  addArrow(
    root,
    new THREE.Vector3(-1.7, -0.72, 0),
    new THREE.Vector3(-1.7 - clamp(friction, 0.4, 1.4), -0.72, 0),
    0xfacc15,
  );
}

function buildForceBalance(
  root: THREE.Group,
  leftForce: number,
  rightForce: number,
  mass: number,
  ...
  const body = box(
    ...
    0.58,
    0.82,
    Math.abs(net) < 0.01 ? 0x94a3b8 : 0x38bdf8,
  );
  ...
  addArrow(
    ...
    new THREE.Vector3(-0.72 - leftLength, -0.66, 0),
    0xf43f5e,
  );
  addArrow(
    root,
    new THREE.Vector3(0.72, -0.66, 0),
    new THREE.Vector3(0.72 + rightLength, -0.66, 0),
    0x34d399,
  );
  if (Math.abs(net) > 0.01) {
    ...
    addArrow(
      ...
      new THREE.Vector3(
        direction * clamp(Math.abs(net) / Math.max(1, mass), 0.7, 2.7),
        0.08,
        0,
      ),
      0xfacc15,
  ...
  root.add(
    label(
      Math.abs(net) < 0.01 ? "balanced" : `net ${net.toFixed(0)} N`,
      new THREE.Vector3(-0.15, 0.62, 0),
      0xfacc15,
    ),
  );
}
...
function buildFreeFall(
  ...
  ball.userData.path = [
    ...
    new THREE.Vector3(0, 2.65 - drop * 3.25, 0),
  ];
  root.add(ball);
  ...
  root.add(
    label(
      `v = u + gt | g ${(gravity || 9.81).toFixed(1)}`,
      new THREE.Vector3(-1.95, -0.6, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-1.95, -0.92, 0.2),
      0xfacc15,
    ),
  );
}

function buildMassWeight(
  root: THREE.Group,
  mass: number,
  gravity: number,
  _unused: number,
  ...
  const planet = sphere(
    1.05,
    g > 15 ? 0xf97316 : g < 4 ? 0x94a3b8 : 0x38bdf8,
    0.62,
  );
  planet.scale.y = 0.18;
  ...
  root.add(
    tube(
      Array.from(
        ...
        (_, index) =>
          new THREE.Vector3(
            0.3 + Math.sin(index * Math.PI) * 0.09,
            1.06 - index * (stretch / 30),
            0,
          ),
      ),
      0.018,
  ...
  addArrow(
    root,
    new THREE.Vector3(1.78, 0.95, 0),
    new THREE.Vector3(1.78, -0.08, 0),
    0xf43f5e,
  );
  root.add(
    label(
      `mass ${m.toFixed(1)} kg unchanged`,
      new THREE.Vector3(-2.55, 0.86, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `weight ${(m * g).toFixed(1)} N`,
      new THREE.Vector3(0.62, -0.64, 0.2),
      0xfacc15,
    ),
  );
}

function buildWorkPower(
  root: THREE.Group,
  force: number,
  distance: number,
  time: number,
  ...
  addArrow(
    ...
    new THREE.Vector3(0.45, 0.47, 0),
    0x22d3ee,
  );
  addArrow(
    root,
    new THREE.Vector3(-1.5, -0.95, 0.28),
    new THREE.Vector3(1.45, -0.95, 0.28),
    0x34d399,
  );
  ...
  root.add(
    label(
      `F ${force.toFixed(1)} N`,
      new THREE.Vector3(0.08, 0.76, 0.2),
      0x22d3ee,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-0.8, -0.82, 0.45),
      0x34d399,
    ),
  );
  root.add(
    label(
      `W ${work.toFixed(1)} J | P ${power.toFixed(1)} W`,
      new THREE.Vector3(-2.35, 1.35, 0.2),
      0xfacc15,
    ),
  );
}
...
function buildVector3D(
  ...
  root.add(
    label(
      `x ${(Math.cos(theta) * magnitude).toFixed(1)}`,
      new THREE.Vector3(end.x / 2, -0.55, 0.08),
      0x22d3ee,
    ),
  );
  root.add(
    label(
      `y ${(Math.sin(theta) * magnitude).toFixed(1)}`,
      new THREE.Vector3(end.x + 0.12, (end.y - 0.8) / 2, 0.08),
      0x34d399,
    ),
  );
}

function buildRotationalDynamics(
  root: THREE.Group,
  force: number,
  radius: number,
  inertia: number,
  ...
  addArrow(
    root,
    new THREE.Vector3(r, 0, 0.35),
    new THREE.Vector3(r, 0.95, 0.35),
    0xf43f5e,
  );
  addArrow(
    root,
    new THREE.Vector3(-0.8, -0.9, 0.35),
    new THREE.Vector3(0.55, -0.9, 0.35),
    0x22d3ee,
  );
  root.add(
    label(
      `tau ${(force * radius).toFixed(1)} N m`,
      new THREE.Vector3(-2.2, 1.25, 0.2),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `alpha ${((force * radius) / Math.max(0.2, inertia)).toFixed(2)} rad/s^2`,
...
function buildSatelliteOrbit(
  ...
  const orbit = new THREE.Mesh(
    new THREE.TorusGeometry(r, 0.014, 12, 96),
    material(
      speed > Math.sqrt(Math.max(0.1, massFactor) / Math.max(1, radius)) * 10
        ? 0xf43f5e
        : 0x22d3ee,
      0.9,
    ),
  ...
  addArrow(
    root,
    new THREE.Vector3(r, 0.04, 0),
    new THREE.Vector3(r, 0.04, 0.9),
    0x22d3ee,
  );
  addArrow(
    root,
  ...
  root.add(
    label("velocity tangent", new THREE.Vector3(r - 0.2, 0.42, 0.85), 0x22d3ee),
  );
  root.add(
    label("gravity inward", new THREE.Vector3(0.65, 0.42, 0.12), 0xf43f5e),
  );
  root.add(
    label("not to scale", new THREE.Vector3(-1.9, -0.84, 0.2), 0xfacc15),
  );
}

function buildUniformMotion(
  root: THREE.Group,
  speed: number,
  time: number,
  start: number,
  ...
  addArrow(
    root,
    cart.position.clone().add(new THREE.Vector3(0.4, 0.2, 0)),
    cart.position.clone().add(new THREE.Vector3(1.35, 0.2, 0)),
    0x22d3ee,
  );
  root.add(
    label(
      `constant v ${speed.toFixed(1)} m/s`,
      new THREE.Vector3(-2.35, 0.75, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-1.15, -0.98, 0.35),
      0xfacc15,
    ),
  );
}

function buildElasticCollision(
  root: THREE.Group,
  mass1: number,
  mass2: number,
  speed: number,
  ...
  addArrow(
    root,
    new THREE.Vector3(-1.85, 0.12, 0),
    new THREE.Vector3(-0.8, 0.12, 0),
    0x22d3ee,
  );
  addArrow(
    root,
    new THREE.Vector3(1.75, 0.12, 0),
  ...
  root.add(
    label(
      `m1 ${m1.toFixed(1)} kg`,
      new THREE.Vector3(-2.2, 0.62, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `m2 ${m2.toFixed(1)} kg`,
      new THREE.Vector3(0.8, 0.62, 0.2),
      0xfacc15,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-1.6, -0.95, 0.25),
      0x34d399,
    ),
  );
}

function buildHookesLaw(
  root: THREE.Group,
  springConstant: number,
  force: number,
  extensionInput: number,
) {
  addPlatform(root);
  ...
  root.add(
    tube(
      Array.from(
        ...
        (_, index) =>
          new THREE.Vector3(
            0.22 + Math.sin(index * Math.PI) * 0.09,
            1.15 - index * (extension / 18),
            0,
          ),
      ),
      0.018,
  ...
  addArrow(
    root,
    mass.position.clone().add(new THREE.Vector3(0.48, 0.2, 0)),
    mass.position.clone().add(new THREE.Vector3(0.48, -0.55, 0)),
    0xf43f5e,
  );
  addArrow(
    root,
    mass.position.clone().add(new THREE.Vector3(-0.48, 0, 0)),
    mass.position.clone().add(new THREE.Vector3(-0.48, 0.68, 0)),
    0x22d3ee,
  );
  root.add(
    label(`F ${f.toFixed(1)} N`, new THREE.Vector3(0.86, 0.34, 0.2), 0xf43f5e),
  );
  root.add(
    label(
      `x ${(f / k).toFixed(3)} m`,
      new THREE.Vector3(-0.1, -0.82, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      extension > 0.45 ? "elastic limit warning" : "within elastic limit",
      new THREE.Vector3(-2.0, -0.95, 0.2),
      extension > 0.45 ? 0xf43f5e : 0x34d399,
    ),
  );
}
...
function buildIncline(
  ...
  const contactStrip = box(
    rampLength * 0.94,
    0.018,
    rampDepth * 0.86,
    moving ? 0x22d3ee : 0xfacc15,
  );
  contactStrip.rotation.z = -theta;
  contactStrip.position.copy(
    rampCenter.clone().addScaledVector(normal, rampThickness / 2 + 0.018),
  );
  ...
  block.position.copy(
    pointOnIncline(rampCenter, tangent, normal, slideStart, clearance),
  );
  ...
  block.userData.speed = moving
    ? clamp(Math.sqrt(acceleration) * 0.42, 0.32, 2.8)
    : 0;
  block.userData.moving = moving;
  block.userData.theta = theta;
  root.add(block);

  const samplePosition = pointOnIncline(
    rampCenter,
    tangent,
    normal,
    -0.2,
  ...
  addArrow(
    ...
    samplePosition
      .clone()
      .add(new THREE.Vector3(0, -clamp((m * g) / 55, 0.45, 1.3), 0)),
    0xf43f5e,
  );
  addArrow(
    root,
    ...
    samplePosition
      .clone()
      .addScaledVector(normal, clamp(normalForce / 55, 0.35, 1.25)),
    0x38bdf8,
  );
  addArrow(
    root,
    ...
    samplePosition
      .clone()
      .addScaledVector(tangent, -clamp(frictionForce / 55, 0.25, 1.1)),
    0xfacc15,
  );
  if (moving) {
    addArrow(
      root,
      samplePosition.clone().addScaledVector(normal, -0.2),
      samplePosition
        .clone()
        .addScaledVector(tangent, clamp(netDownPlane / 55, 0.35, 1.45)),
      0x34d399,
    );
  }
  root.add(
    label(
      ...
      samplePosition.clone().add(new THREE.Vector3(0.15, 0.55, 0.08)),
      moving ? 0x34d399 : 0xfacc15,
    ),
  );
  root.add(
    label(
      moving ? "block stays on ramp surface" : "static friction holds",
      pointOnIncline(
        rampCenter,
        tangent,
        normal,
...
function buildCircular(
  ...
  addArrow(
    root,
    new THREE.Vector3(r, -0.75, 0),
    new THREE.Vector3(0.2, -0.75, 0),
    0xf43f5e,
  );
}

function buildGravityMap(
  root: THREE.Group,
  centralMass: number,
  testMass: number,
  distance: number,
  ...
  satellite.userData.speed = clamp(
    centralMass / Math.sqrt(Math.max(1, distance)),
    0.25,
    2.7,
  );
  root.add(satellite);
  const pullStart = new THREE.Vector3(orbitRadius, -0.55, 0);
  const pullEnd = new THREE.Vector3(
    clamp(sourceRadius + 0.15, 0.55, 0.9),
    -0.45,
    0,
  );
  ...
  addArrow(
    root,
    new THREE.Vector3(-2.8, 1.05, 0),
    new THREE.Vector3(
      -2.8,
      1.05 - clamp(centralMass / Math.max(1, distance), 0.35, 1.35),
      0,
    ),
    0x34d399,
  );
  ...
  root.add(
    label(
      "test mass",
      new THREE.Vector3(orbitRadius - 0.6, 0.42, 0.2),
      0xfacc15,
    ),
  );
}
...
function buildBuoyancy(
  ...
  const block = box(
    ...
    0.58,
    0.72,
    objectDensity < fluidDensity ? 0xa3e635 : 0x94a3b8,
  );
...
function buildDensityTank(
  ...
  const block = box(
    ...
    blockHeight,
    0.85,
    floats ? 0xa3e635 : neutral ? 0xfacc15 : 0xf97316,
    0.92,
  );
  ...
  const submergedHeight = clamp(
    blockHeight * Math.min(1, fraction),
    0.08,
    blockHeight,
  );
  const submerged = box(0.9, submergedHeight, 0.9, 0x22d3ee, 0.22);
  submerged.position.set(
    0,
    block.position.y - blockHeight / 2 + submergedHeight / 2,
    0,
  );
  root.add(submerged);
  addArrow(
    root,
    new THREE.Vector3(1.45, -0.8, 0),
    new THREE.Vector3(1.45, -0.8 + clamp(fluidDensity / 900, 0.55, 1.45), 0),
    0x34d399,
  );
  addArrow(
    root,
    new THREE.Vector3(-1.45, 0.1, 0),
    new THREE.Vector3(-1.45, 0.1 - clamp(objectDensity / 1600, 0.45, 1.55), 0),
    0xf43f5e,
  );
...
function buildFluid(
  ...
  addArrow(
    root,
    new THREE.Vector3(-2.2, probe.position.y, 0),
    new THREE.Vector3(
      -2.2 + clamp(force / Math.max(area, 0.2), 0.5, 1.9),
      probe.position.y,
      0,
    ),
    0xf43f5e,
...
function buildBernoulliVenturi(
  root: THREE.Group,
  density: number,
  wideArea: number,
  flowRate: number,
  ...
  root.add(
    tube(
      [new THREE.Vector3(-1.5, -0.25, 0), new THREE.Vector3(-0.65, -0.25, 0)],
      0.09,
      0x67e8f9,
      0.28,
    ),
  ...
  root.add(
    tube(
      [new THREE.Vector3(0.65, -0.25, 0), new THREE.Vector3(1.5, -0.25, 0)],
      0.09,
      0x67e8f9,
      0.28,
    ),
  ...
  const tapWide = box(
    0.08,
    clamp(1.2 - pressureDrop / 90000, 0.35, 1.2),
    0.08,
    0xfacc15,
    0.92,
  );
  ...
  const tapNarrow = box(
    0.08,
    clamp(0.45 + pressureDrop / 150000, 0.22, 0.85),
    0.08,
    0xf43f5e,
    0.92,
  );
  ...
  addArrow(
    root,
    new THREE.Vector3(-2.8, -0.95, 0.35),
    new THREE.Vector3(-1.75, -0.95, 0.35),
    0x22d3ee,
  );
  addArrow(
    root,
    new THREE.Vector3(-0.45, -0.95, 0.35),
    new THREE.Vector3(1.05, -0.95, 0.35),
    0x34d399,
  );
  root.add(
    label(
      "wide: high P, low v",
      new THREE.Vector3(-2.95, 1.28, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label(
      "throat: low P, high v",
      new THREE.Vector3(-0.85, 1.08, 0.25),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      `v1 ${vWide.toFixed(2)} | v2 ${vNarrow.toFixed(2)}`,
      new THREE.Vector3(-1.35, -1.02, 0.65),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `Delta P ${(pressureDrop / 1000).toFixed(1)} kPa`,
      new THREE.Vector3(0.95, 1.28, 0.25),
      0xa3e635,
    ),
  );
  root.add(
    label(
      "steady incompressible ideal flow",
...
function buildThermal(
  ...
  for (let index = 0; index < count; index += 1) {
    const particle = sphere(
      0.055 + clamp(mass / 100, 0, 0.04),
      index % 3 === 0 ? 0xfacc15 : 0xfb923c,
    );
    particle.position.set(
      ((index % 7) - 3) * 0.42,
      -0.65 + Math.floor(index / 7) * 0.42,
      ((index % 5) - 2) * 0.26,
    );
    particle.userData.role = "particle";
    particle.userData.speed = clamp(
      (temperature + 30) / 180 + volume / 10,
      0.3,
      3,
    );
...
function buildCalorimetry(
  ...
  const finalTemperature =
    (Math.max(0.01, hotMass) * hotTemperature +
      Math.max(0.01, coldMass) * coldTemperature) /
    (Math.max(0.01, hotMass) + Math.max(0.01, coldMass));
  ...
  root.add(
    tube(
      [
        ...
        new THREE.Vector3(-1.2, -0.55, 0.15),
        new THREE.Vector3(-0.55, -0.55, 0.04),
      ],
      0.035,
      0xf97316,
      0.72,
  ...
  const mercury = box(
    ...
    mercuryHeight * 1.24,
    0.055,
    finalTemperature > 60 ? 0xf43f5e : 0xfacc15,
    0.94,
  );
  ...
  for (let index = 0; index < 28; index += 1) {
    ...
    particle.position.set(
      ((index % 7) - 3) * 0.17,
      -0.86 + Math.floor(index / 7) * 0.16,
      ((index % 5) - 2) * 0.13,
    );
    particle.userData.role = "particle";
    particle.userData.seed = index * 0.77;
    particle.userData.speed = clamp(
      (isHot ? hotTemperature : coldTemperature) / 50,
      0.6,
      2.8,
    );
    root.add(particle);
  ...
  root.add(
    label(
      `Tf ${finalTemperature.toFixed(1)} C`,
      new THREE.Vector3(-0.48, 1.22, 0),
      finalTemperature > 55 ? 0xf97316 : 0xfacc15,
    ),
  );
}

function buildThermoProcess(
  root: THREE.Group,
  pressure: number,
  deltaVolume: number,
  processInput: number,
  ...
  const process = ["isothermal", "adiabatic", "isobaric", "isochoric"][
    processIndex
  ];
  ...
  for (let index = 0; index < 18; index += 1) {
    ...
    particle.position.set(
      -1.78 + (index % 5) * 0.2,
      -0.78 + Math.floor(index / 5) * 0.22,
      ((index % 4) - 1.5) * 0.18,
    );
    particle.userData.role = "particle";
    particle.userData.seed = index * 0.81;
    particle.userData.speed =
      process === "isothermal" ? 0.9 : process === "adiabatic" ? 1.35 : 1.05;
    root.add(particle);
  }
  if (process !== "adiabatic") {
    addArrow(
      root,
      new THREE.Vector3(-2.9, -0.15, 0.34),
      new THREE.Vector3(-2.15, -0.15, 0.2),
      0xf97316,
    );
    root.add(
      label("heat exchange", new THREE.Vector3(-3.05, 0.22, 0.35), 0xf97316),
    );
  } else {
    const insulation = new THREE.Mesh(
      new THREE.TorusGeometry(0.95, 0.035, 12, 72),
      material(0xfacc15, 0.72),
    );
    ...
    root.add(
      label(
        ...
        new THREE.Vector3(-2.45, 0.95, 0.25),
        0xfacc15,
      ),
    );
  }
  ...
  addArrow(
    ...
    new THREE.Vector3(
      0.15 + Math.cos(pressure / 115) * 0.34,
      0.7 + Math.sin(pressure / 115) * 0.34,
      0,
    ),
    0xf43f5e,
  );
  ...
  addArrow(
    root,
    origin,
    origin.clone().add(new THREE.Vector3(1.85, 0, 0)),
    0x94a3b8,
  );
  addArrow(
    root,
    origin,
    origin.clone().add(new THREE.Vector3(0, 1.55, 0)),
    0x94a3b8,
  );
  const pathPoints =
    process === "isobaric"
      ? [
          new THREE.Vector3(1.25, -0.15, 0.15),
          new THREE.Vector3(2.72, -0.15, 0.15),
        ]
      : process === "isochoric"
        ? [
            new THREE.Vector3(1.85, -0.72, 0.15),
            new THREE.Vector3(1.85, 0.48, 0.15),
          ]
        : Array.from({ length: 42 }, (_, index) => {
            const u = index / 41;
            return new THREE.Vector3(
              1.25 + u * 1.55,
              0.48 - (process === "adiabatic" ? u ** 1.4 : u ** 1.15) * 1.25,
              0.15,
            );
          });
  const pvPath = tube(
    pathPoints,
    0.025,
    process === "adiabatic" ? 0xfacc15 : 0x22d3ee,
    0.95,
  );
  ...
  root.add(tracer);
  root.add(
    label(`P-V ${process}`, new THREE.Vector3(1.15, 0.88, 0.2), 0x67e8f9),
  );
  root.add(
    label(
      `work ${(process === "isochoric" ? 0 : (pressure * (volume - 3)) / 100).toFixed(2)} kJ`,
      new THREE.Vector3(1.16, -1.2, 0.35),
      0xfacc15,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-2.75, -1.08, 0.25),
      0x94a3b8,
    ),
  );
}

function buildStatisticalEnsemble(
  root: THREE.Group,
  temperature: number,
  particleInput: number,
  interaction: number,
) {
  addPlatform(root);
  ...
  for (let index = 0; index < 34; index += 1) {
    ...
    const particle = sphere(
      isHighEnergy ? 0.055 : 0.04,
      isHighEnergy ? 0xfacc15 : 0x38bdf8,
      0.86,
    );
    particle.position.set(
  ...
  root.add(
    label(
      `samples ${particleCount}`,
      new THREE.Vector3(-2.58, 1.28, 0.25),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-0.55, 1.16, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label("histogram wall", new THREE.Vector3(1.08, 0.92, 0.45), 0x22d3ee),
  );
  root.add(label("mean", new THREE.Vector3(1.84, 0.6, 0.55), 0xf43f5e));
  root.add(
    label(
      "qualitative ensemble model",
      new THREE.Vector3(-2.55, -1.22, 0.25),
      0x94a3b8,
    ),
  );
}
...
function buildStaticElectricity(
  root: THREE.Group,
  chargeA: number,
  chargeB: number,
  distance: number,
  ...
  root.add(
    label(
      q1 > 0 ? "+" : "-",
      left.position.clone().add(new THREE.Vector3(-0.08, 0.08, 0.5)),
      0xffffff,
    ),
  );
  root.add(
    label(
      q2 > 0 ? "+" : "-",
      right.position.clone().add(new THREE.Vector3(-0.08, 0.08, 0.5)),
      0xffffff,
    ),
  );
  for (let index = 0; index < 8; index += 1) {
    ...
    const curve = tube(
      [
        ...
        new THREE.Vector3(
          0,
          y + (q1 === q2 ? (index < 4 ? -0.42 : 0.42) : 0.25 * Math.sin(index)),
          0.18,
        ),
        new THREE.Vector3(gap - 0.35, y, 0),
      ],
      0.01,
      q1 === q2 ? 0xfacc15 : 0x22d3ee,
      0.58,
    );
  ...
  addArrow(
    root,
    left.position.clone().add(new THREE.Vector3(0, 0.65, 0)),
    left.position.clone().add(new THREE.Vector3(direction * 0.95, 0.65, 0)),
    q1 === q2 ? 0xf97316 : 0x34d399,
  );
  addArrow(
    root,
    right.position.clone().add(new THREE.Vector3(0, 0.65, 0)),
    right.position.clone().add(new THREE.Vector3(-direction * 0.95, 0.65, 0)),
    q1 === q2 ? 0xf97316 : 0x34d399,
  );
  if (Math.abs(chargeA * chargeB) / Math.max(1, distance) > 25) {
    const spark = tube(
      [
        ...
        new THREE.Vector3(0.25, 0.04, 0.12),
      ],
      0.022,
      0xfacc15,
      0.95,
  ...
  root.add(
    label(
      q1 === q2 ? "repulsion" : "attraction",
      new THREE.Vector3(-0.5, 1.18, 0.2),
      q1 === q2 ? 0xf97316 : 0x34d399,
    ),
  );
  root.add(
    label(
      "qualitative charge model",
      new THREE.Vector3(-2.6, -1.0, 0.25),
      0x94a3b8,
    ),
  );
}

function buildElectrostaticField(
  root: THREE.Group,
  charge: number,
  distance: number,
  testCharge: number,
  ...
  for (let index = 0; index < 12; index += 1) {
    ...
    const end = new THREE.Vector3(
      Math.cos(angle) * 2.35 * q,
      -0.18,
      Math.sin(angle) * 2.35 * q,
    );
    addArrow(root, start, end, 0x22d3ee);
  }
  [0.75, 1.25, 1.85].forEach((radius, index) => {
    const equipotential = new THREE.Mesh(
      new THREE.TorusGeometry(radius, 0.012, 10, 96),
      material(index === 0 ? 0xfacc15 : 0x67e8f9, 0.38),
    );
  ...
  addArrow(
    ...
    test.position
      .clone()
      .add(new THREE.Vector3(q * Math.sign(testCharge || 1) * 0.85, 0, 0)),
    0xf43f5e,
  );
  root.add(
    label(
      "point charge",
      new THREE.Vector3(-0.48, 0.62, 0.2),
      q > 0 ? 0xf43f5e : 0x38bdf8,
    ),
  );
  root.add(
    label(
      "equipotential rings",
      new THREE.Vector3(0.85, -1.05, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `E ~ 1/r^2 | V ~ 1/r`,
      new THREE.Vector3(-2.55, 1.18, 0.25),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      "singularity visually clamped",
      new THREE.Vector3(-2.55, -1.22, 0.25),
      0x94a3b8,
    ),
  );
...
function buildElectrolysis(
  ...
  const deposit = box(
    0.2,
    clamp((current * time * (chargeScale || 1)) / 80, 0.08, 0.75),
    0.16,
    0xfacc15,
    0.9,
  );
  ...
  for (let index = 0; index < 22; index += 1) {
    ...
    ion.position.set(
      -0.72 + ((index * 37) % 140) / 100,
      -0.9 + ((index * 19) % 100) / 100,
      -0.45 + ((index * 23) % 90) / 100,
    );
    ion.userData.role = "path";
    ion.userData.path =
      index % 2
        ? [ion.position.clone(), new THREE.Vector3(0.48, -0.35, ion.position.z)]
        : [
            ion.position.clone(),
            new THREE.Vector3(-0.48, -0.35, ion.position.z),
          ];
  ...
  root.add(
    label("cathode - deposit", new THREE.Vector3(0.5, 0.8, 0.2), 0xfacc15),
  );
  root.add(
    label(
      "simplified electrolysis model",
...
function buildMeterBridge(
  ...
  root.add(wire);
  const l = clamp(
    balanceInput || (known / Math.max(1, known + unknown)) * 100,
    8,
    92,
  );
  ...
  root.add(
    label(
      `l ${l.toFixed(1)} cm`,
      new THREE.Vector3(x - 0.3, 0.74, 0.35),
      0xfacc15,
    ),
  );
  root.add(
    label("jockey probe", new THREE.Vector3(x - 0.45, 1.02, 0.35), 0xe2e8f0),
  );
  root.add(
    label("galvanometer null", new THREE.Vector3(-0.55, 0.96, -0.4), 0xfacc15),
  );
  root.add(
    label(
      "uniform wire; contact resistance ignored",
      new THREE.Vector3(-2.65, -1.16, 0.25),
      0x94a3b8,
    ),
  );
}

function buildInternalCell(
  root: THREE.Group,
  emf: number,
  ...
  root.add(
    label(
      `EMF ${e.toFixed(1)} V`,
      new THREE.Vector3(-2.35, 0.28, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `terminal ${terminal.toFixed(2)} V`,
      new THREE.Vector3(0.75, 1.02, 0.2),
      0x67e8f9,
    ),
  );
  root.add(
    label("internal drop Ir", new THREE.Vector3(-1.75, -1.12, 0.25), 0xf97316),
  );
  root.add(
    label(
      "linear internal resistance model",
      new THREE.Vector3(-2.65, -1.35, 0.25),
      0x94a3b8,
    ),
  );
}

function buildKirchhoff3D(
  root: THREE.Group,
  voltage: number,
  r1: number,
  r2: number,
  ...
  root.add(
    tube([new THREE.Vector3(-2.55, -0.55, 0), nodes[0]], 0.035, 0xfacc15, 0.95),
  );
  root.add(
    tube([nodes[1], new THREE.Vector3(2.55, -0.55, 0)], 0.035, 0xfacc15, 0.95),
  );
  ...
  root.add(
    label(
      "KCL: I in = I1 + I2",
      new THREE.Vector3(-2.45, 0.35, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `V drops: R1 ${r1.toFixed(1)}, R2 ${r2.toFixed(1)}`,
      new THREE.Vector3(-0.85, 0.95, 0.25),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `source ${voltage.toFixed(1)} V`,
      new THREE.Vector3(1.55, 0.35, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-2.35, -1.18, 0.25),
      0x94a3b8,
    ),
  );
}
...
function buildLcr3D(
  ...
  addArrow(
    root,
    new THREE.Vector3(-1.35, -0.28, 0),
    new THREE.Vector3(-0.85, -0.28, 0),
    0x34d399,
  );
  addArrow(
    root,
    new THREE.Vector3(-1.35, -0.28, 0),
    new THREE.Vector3(-1.35, near ? 0.25 : 0.05, 0),
    0xf43f5e,
  );
  ...
  root.add(
    label(
      near ? "resonance peak" : `f0 ${f0.toFixed(0)} Hz`,
      new THREE.Vector3(0.68, 0.98, 0.25),
      near ? 0x34d399 : 0xfacc15,
    ),
  );
  root.add(
    label(
      `R ${resistance.toFixed(1)} ohm | RMS AC`,
      new THREE.Vector3(-2.55, -1.15, 0.25),
      0x94a3b8,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(0.8, -1.22, 0.25),
      0x94a3b8,
    ),
  );
}

function buildLorentz3D(
  root: THREE.Group,
  chargeInput: number,
  speedInput: number,
  fieldInput: number,
  ...
  for (let x = -1; x <= 2; x += 1) {
    for (let y = -1; y <= 1; y += 1) {
      ...
      root.add(
        label(
          symbol,
          new THREE.Vector3(x * 0.72, y * 0.42 - 0.18, -0.78),
          0x67e8f9,
        ),
      );
      addArrow(
        root,
        new THREE.Vector3(x * 0.72, y * 0.42 - 0.18, -0.42),
        new THREE.Vector3(x * 0.72, y * 0.42 - 0.18, 0.42),
        0x22d3ee,
      );
    }
  ...
  addArrow(
    root,
    new THREE.Vector3(-0.75, -0.18, 0.55),
    new THREE.Vector3(-0.75, -0.18, 1.32),
    0x22d3ee,
  );
  root.add(
    label("B out of page", new THREE.Vector3(-0.58, 0.18, 1.05), 0x67e8f9),
  );
  addArrow(
    root,
    new THREE.Vector3(-0.42, -0.18, 0),
    new THREE.Vector3(-0.42, -0.18 + forceDirection * 1.05, 0),
    qSign > 0 ? 0xf43f5e : 0xfb7185,
  );
  root.add(
    label(
      qSign > 0 ? "F downward" : "F upward",
      new THREE.Vector3(-0.18, -0.18 + forceDirection * 1.12, 0.12),
      0xf43f5e,
    ),
  );
  ...
  root.add(
    label(
      `r = mv/|q|B ~ ${radius.toFixed(2)} m`,
      new THREE.Vector3(0.72, -1.18, 0.22),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `F = q(v x B) | ${forceMag.toFixed(1)} N cue`,
      new THREE.Vector3(-2.65, 1.18, 0.22),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      qSign > 0 ? "positive charge" : "negative charge reverses force",
      new THREE.Vector3(-2.65, -1.16, 0.22),
      qSign > 0 ? 0xfacc15 : 0xa78bfa,
    ),
  );
  root.add(
    label(
      "uniform B; non-relativistic; v perpendicular B",
      new THREE.Vector3(0.25, 1.18, 0.22),
      0x94a3b8,
    ),
  );
}
...
function buildElectromagnet(
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(-2.55, 1.02, 0.2),
      0xfacc15,
    ),
  );
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(-2.65, -1.18, 0.2),
      0x94a3b8,
    ),
  );
}
...
function buildGenerator(
  ...
  const poles = [
    box(0.55, 2.25, 0.78, 0xf43f5e),
    box(0.55, 2.25, 0.78, 0x38bdf8),
  ];
  ...
  const waveform = sineWave(
    2.8,
    0.62,
    clamp((turns * field) / 250, 0.18, 0.95),
    0x22d3ee,
  );
...
function buildTransformer(
  ...
  const primary = helix(
    0.95,
    0.42,
    Math.round(clamp(primaryTurns / 80, 5, 13)),
    0xf97316,
  );
  primary.position.x = -0.85;
  root.add(primary);
  const secondary = helix(
    0.95,
    0.42,
    Math.round(clamp(secondaryTurns / 100, 5, 16)),
    0x22d3ee,
  );
  secondary.position.x = 0.85;
  root.add(secondary);
  for (let index = 0; index < 5; index += 1) {
    const fieldLoop = roundedFluxLoop(
      1.65 + index * 0.05,
      0.78 + index * 0.03,
      0x34d399,
    );
  ...
  const primaryBar = box(
    0.2,
    clamp(primaryVoltage / 120, 0.25, 1.45),
    0.16,
    0xf97316,
    0.86,
  );
  ...
  root.add(primaryBar);
  const secondaryBar = box(
    0.2,
    clamp((primaryVoltage * ratio) / 120, 0.25, 1.6),
    0.16,
    0x22d3ee,
    0.86,
  );
  ...
  root.add(
    label(
      ratio >= 1 ? "step-up" : "step-down",
      new THREE.Vector3(1.62, 1.25, 0),
      0x22d3ee,
    ),
  );
}
...
function buildLens(root: THREE.Group, a: number, b: number, _unused = 0) {
  ...
  addArrow(
    root,
    new THREE.Vector3(objectX, 0.2, 0),
    new THREE.Vector3(objectX, 0.8, 0),
    0xf43f5e,
  );
  ...
  [-0.58, 0, 0.58].forEach((y, index) => {
    ...
    root.add(
      tube(
        [
          new THREE.Vector3(objectX, 0.55, z),
          new THREE.Vector3(0, y * 0.18, z * 0.5),
          new THREE.Vector3(imageX, -0.55, z * -0.4),
        ],
        0.014,
        index === 1 ? 0xffffff : 0xfacc15,
        0.86,
      ),
    );
  });
  ...
  photon.userData.path = [
    new THREE.Vector3(objectX, 0.55, 0),
    new THREE.Vector3(0, 0.05, 0),
    new THREE.Vector3(imageX, -0.55, 0),
  ];
  root.add(photon);
  addMarker(root, new THREE.Vector3(-objectDistance, -0.82, 0), 0xfacc15);
  addMarker(root, new THREE.Vector3(objectDistance, -0.82, 0), 0xfacc15);
  root.add(
    label("object", new THREE.Vector3(objectX - 0.25, 1.1, 0), 0xf43f5e),
  );
  root.add(label("convex lens", new THREE.Vector3(-0.15, 1.55, 0), 0x67e8f9));
  root.add(
    label("image screen", new THREE.Vector3(imageX - 0.35, 1.1, 0), 0x22d3ee),
  );
  root.add(label("F", new THREE.Vector3(objectDistance, -0.45, 0), 0xfacc15));
}

function buildEyeFocus(
  root: THREE.Group,
  focusCm: number,
  retinaCm: number,
  defectMode: number,
  ...
  const focusOffset =
    mode === 0
      ? clamp((focusCm - retinaCm) * 0.42, -0.42, 0.42)
      : clamp((focusCm - retinaCm) * 0.72, -0.9, 0.9);
  ...
  if (mode > 0) {
    ...
    root.add(
      label(
        mode === 1 ? "concave lens" : "convex lens",
        new THREE.Vector3(-2.62, 1.42, 0),
        lensColor,
      ),
    );
  }
  ...
  [-0.44, 0, 0.44].forEach((y, index) => {
    ...
    const uncorrectedEnd = new THREE.Vector3(
      uncorrectedFocusX,
      0.12,
      z * -0.12,
    );
    ...
    root.add(
      tube(
        [start, correction, crystalline, uncorrectedEnd],
        0.012,
        0xfb7185,
        0.42,
      ),
    ...
    root.add(
      tube(
        [
          start.clone().add(new THREE.Vector3(0, 0.02, 0)),
          correction,
          crystalline,
          correctedEnd,
        ],
  ...
  addMarker(
    root,
    new THREE.Vector3(uncorrectedFocusX, 0.12, -0.42),
    Math.abs(uncorrectedFocusX - retinaX) < 0.14 ? 0x34d399 : 0xfb7185,
  );
  addMarker(
    root,
    new THREE.Vector3(correctedFocusX, 0.12, 0.42),
    Math.abs(correctedFocusX - retinaX) < 0.14 ? 0x34d399 : 0xfb7185,
  );
  addArrow(
    root,
    new THREE.Vector3(-0.18, 1.06, 0),
    new THREE.Vector3(correctedFocusX, 0.34, 0),
    0x22d3ee,
  );
  ...
  root.add(
    label(
      mode === 1
        ...
        : mode === 2
          ? "hypermetropia: behind retina"
          : "normal: on retina",
      new THREE.Vector3(-2.55, -1.0, 0),
      mode === 0 ? 0x34d399 : 0xfacc15,
    ),
  );
}
...
function buildPrism(
  ...
  const prism = new THREE.Mesh(
    new THREE.CylinderGeometry(0.95, 0.95, 1.2, 3),
    material(0xa78bfa, 0.32),
  );
  ...
  root.add(
    line(
      [new THREE.Vector3(-3.1, 0.55, 0), new THREE.Vector3(-0.55, 0.12, 0)],
      0xffffff,
    ),
  );
  root.add(
    line(
      [new THREE.Vector3(-0.52, 0.12, 0), new THREE.Vector3(0.48, -0.02, 0)],
      0xfde047,
    ),
  );
  root.add(
    line(
      [new THREE.Vector3(-0.55, 0.52, 0), new THREE.Vector3(-0.2, -0.32, 0)],
      0x94a3b8,
      0.65,
    ),
  );
  root.add(
    line(
      [new THREE.Vector3(0.25, 0.38, 0), new THREE.Vector3(0.75, -0.48, 0)],
      0x94a3b8,
      0.65,
    ),
  );
  if (model.tirInside) {
    root.add(
      line(
        [new THREE.Vector3(0.48, -0.02, 0), new THREE.Vector3(-0.25, -0.58, 0)],
        0xfacc15,
      ),
    );
    root.add(
    ...
    model.rays.forEach((ray, index) => {
      ...
      root.add(
        line(
          [new THREE.Vector3(0.48, -0.02, 0), new THREE.Vector3(2.95, y, z)],
          color,
        ),
      );
      if (index === 0 || index === model.rays.length - 1) {
        root.add(
          label(ray.name.toLowerCase(), new THREE.Vector3(3.12, y, z), color),
        );
      }
    });
  }
  model.rays.forEach((ray, index) => {
    const band = box(
      ...
      0.1,
      0.92,
      new THREE.Color(ray.color).getHex(),
      0.82,
    );
    band.position.set(
      3.12,
      -0.54 + index * 0.18 + clamp(model.spreadDeg / 8, 0, 0.32),
      0,
    );
    root.add(band);
  });
  root.add(
    label(
      `A ${model.prismAngleDeg.toFixed(0)} deg`,
  ...
  root.add(
    label(
      `Dm ${model.minimumDeviationDeg.toFixed(1)} deg`,
  ...
  root.add(
    label(
      model.material.name.toLowerCase(),
      new THREE.Vector3(1.75, -1.02, 0),
      0xe2e8f0,
    ),
  );
}

function buildPlaneMirror3D(
  root: THREE.Group,
  incidenceInput: number,
  reflectionInput: number,
  distanceInput: number,
) {
  addPlatform(root);
  const incidence = THREE.MathUtils.degToRad(
    clamp(incidenceInput || reflectionInput || 35, 5, 78),
  );
  ...
  addArrow(
    root,
    object.position.clone().add(new THREE.Vector3(0, -0.22, 0)),
    object.position.clone().add(new THREE.Vector3(0, 0.64, 0)),
    0xf43f5e,
  );
  ...
  root.add(
    line(
      [
        new THREE.Vector3(-1.3, hit.y, -0.08),
        new THREE.Vector3(1.3, hit.y, -0.08),
      ],
      0x94a3b8,
      0.72,
  ...
  root.add(
    tube(
      [
        new THREE.Vector3(-distance, -0.96, -0.54),
        new THREE.Vector3(0, -0.96, -0.54),
      ],
      0.01,
      0xf43f5e,
      0.8,
  ...
  root.add(
    label("mirror plane", new THREE.Vector3(-0.42, 1.42, 0.36), 0x93c5fd),
  );
  root.add(
    label(
      "object",
      object.position.clone().add(new THREE.Vector3(-0.38, 0.78, 0)),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      "virtual image",
      image.position.clone().add(new THREE.Vector3(-0.48, 0.78, 0)),
      0x34d399,
    ),
  );
  root.add(
    label("incident ray", new THREE.Vector3(-2.45, 1.0, 0.05), 0xfde047),
  );
  root.add(
    label("reflected ray", new THREE.Vector3(-2.7, -0.98, 0.05), 0x22d3ee),
  );
  root.add(label("normal", new THREE.Vector3(0.95, 0.22, 0.08), 0x94a3b8));
  root.add(
    label("equal distance", new THREE.Vector3(-0.58, -1.22, -0.48), 0xe2e8f0),
  );
  root.add(
    label("ideal plane mirror", new THREE.Vector3(1.42, 1.28, 0.2), 0xfacc15),
  );
}

function buildGlassSlab3D(
  root: THREE.Group,
  incidenceInput: number,
  indexInput: number,
  thicknessInput: number,
) {
  addPlatform(root);
  const incidence = THREE.MathUtils.degToRad(
    clamp(incidenceInput || 45, 5, 76),
  );
  const refractiveIndex = clamp(indexInput || 1.5, 1.01, 2.4);
  const refraction = Math.asin(
    clamp(Math.sin(incidence) / refractiveIndex, -1, 1),
  );
  const thickness = clamp((thicknessInput || 4) / 8, 0.48, 1.15);
  const lateralShift =
    (thickness * Math.sin(incidence - refraction)) /
    Math.max(0.18, Math.cos(refraction));
  ...
  const start = new THREE.Vector3(
    -3.0,
    p1.y + Math.tan(incidence) * (p1.x + 3.0),
    0,
  );
  const end = new THREE.Vector3(
    3.05,
    p2.y - Math.tan(incidence) * (3.05 - p2.x),
    0,
  );
  const unshiftedEnd = new THREE.Vector3(
    3.05,
    start.y - Math.tan(incidence) * 6.05,
    -0.12,
  );
  ...
  [x1, x2].forEach((x, index) => {
    root.add(
      line(
        [new THREE.Vector3(x, -1.14, 0.04), new THREE.Vector3(x, 1.22, 0.04)],
        0x94a3b8,
        0.7,
      ),
    );
    root.add(
      label(
        index === 0 ? "normal 1" : "normal 2",
        new THREE.Vector3(x - 0.42, -1.34, 0.08),
        0x94a3b8,
      ),
    );
  });
  root.add(
    tube(
      [
        new THREE.Vector3(2.18, end.y, 0.1),
        new THREE.Vector3(2.18, unshiftedEnd.y, 0.1),
      ],
      0.012,
      0xf43f5e,
      0.86,
  ...
  root.add(
    label("incident ray", new THREE.Vector3(-2.55, 1.26, 0.12), 0xfde047),
  );
  root.add(
    label("refracted ray", new THREE.Vector3(-0.55, 0.38, 0.16), 0x22d3ee),
  );
  root.add(
    label(
      "parallel emergent ray",
      new THREE.Vector3(1.2, -0.92, 0.12),
      0xfde047,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(-0.22, -1.28, 0.28),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(0.72, 1.32, 0.2),
      0xe2e8f0,
    ),
  );
  root.add(
    label(
      `lateral shift ${Math.abs(lateralShift).toFixed(2)}`,
      new THREE.Vector3(2.0, 0.82, 0.18),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      "plane parallel slab",
      new THREE.Vector3(-2.72, -1.15, 0.22),
      0xfacc15,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(1.45, 1.38, 0.22),
      0xfacc15,
    ),
  );
}

function buildShadowEclipse3D(
  root: THREE.Group,
  sourceSizeInput: number,
  distanceInput: number,
  modeInput: number,
) {
  addPlatform(root);
  ...
  const penumbra = new THREE.Mesh(
    new THREE.ConeGeometry(1.15, gap + 1.0, 48, 1, true),
    material(0xfacc15, 0.13),
  );
  penumbra.rotation.z = -Math.PI / 2;
  penumbra.position.set((gap - 0.55) / 2, 0, 0);
  root.add(penumbra);
  const umbra = new THREE.Mesh(
    new THREE.ConeGeometry(0.46, gap + 0.45, 48, 1, true),
    material(0x020617, 0.44),
  );
  ...
  [-0.4, 0.4].forEach((z) => {
    root.add(
      line(
        [
          new THREE.Vector3(-2.75, sourceRadius, z),
          new THREE.Vector3(gap, 0.72, z * 0.35),
        ],
        0xfde047,
        0.42,
      ),
    ...
    root.add(
      line(
        [
          new THREE.Vector3(-0.55, 0.34, z * 0.2),
          new THREE.Vector3(gap, 0.22, z * 0.2),
        ],
        0x64748b,
        0.74,
      ),
  ...
  const orbit = new THREE.Mesh(
    new THREE.TorusGeometry(gap + 0.55, 0.006, 8, 120),
    material(0x334155, 0.58),
  );
  orbit.rotation.x = Math.PI / 2;
  ...
  root.add(
    label(
      mode === 1 ? "Earth screen" : mode === 2 ? "Moon screen" : "screen",
      new THREE.Vector3(gap - 0.48, 1.12, 0),
      screenColor,
    ),
  );
  ...
  root.add(
    label("not to scale", new THREE.Vector3(1.55, -1.16, 0.2), 0xfacc15),
  );
}

function buildMultipleReflection3D(
  root: THREE.Group,
  angleInput: number,
  imageInput: number,
  _unused = 0,
  ...
  const imageCount = exact
    ? Math.max(0, Math.round(imageCountRaw) - 1)
  ...
  for (let index = 0; index < 12; index += 1) {
    ...
    const shard = box(
      ...
      0.04,
      0.34,
      [0x22d3ee, 0xf43f5e, 0xfacc15, 0x34d399][index % 4],
      0.76,
    );
    shard.position.set(
      -2.15 + Math.cos(theta) * 0.38,
      -0.68,
      Math.sin(theta) * 0.38,
    );
  ...
  root.add(
    label(
      `mirror angle ${angle.toFixed(0)} deg`,
      new THREE.Vector3(0.58, 0.62, 0.58),
      0xfacc15,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(1.65, 1.12, 0),
      0x34d399,
    ),
  );
  root.add(
    label(
      exact ? "n = 360/theta - 1" : "floor rule condition",
      new THREE.Vector3(-0.52, -1.22, 0.2),
      0xe2e8f0,
    ),
  );
  root.add(
    label("ideal mirrors", new THREE.Vector3(-2.78, 0.62, 0.2), 0x93c5fd),
  );
  root.add(
    label(
      "kaleidoscope preview",
      new THREE.Vector3(-2.92, -1.18, 0.18),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `input cue ${imageInput.toFixed(1)}`,
      new THREE.Vector3(1.45, -1.16, 0.18),
      0x94a3b8,
    ),
  );
}

function buildOpticalInstrument3D(
  root: THREE.Group,
  objectiveFInput: number,
  eyepieceFInput: number,
  modeInput: number,
) {
  addPlatform(root);
  ...
  const magnification =
    mode === "telescope"
      ? objectiveF / Math.max(1, eyepieceF)
      : (objectiveF * 25) / Math.max(1, eyepieceF * 10);
  ...
  if (mode === "microscope") {
    addArrow(
      root,
      new THREE.Vector3(objectX, -0.8, 0),
      new THREE.Vector3(objectX, 0.22, 0),
      0xf43f5e,
    );
    root.add(
      label(
        "near object",
        new THREE.Vector3(objectX - 0.38, 0.58, 0),
        0xf43f5e,
      ),
    );
  } else {
      ...
      root.add(
        line(
          [
            ...
            new THREE.Vector3(objectiveX, y * 0.5 - 0.12, 0),
          ],
          0xfde047,
          0.7,
        ),
  ...
  const rayStarts =
    mode === "microscope"
      ? [
          new THREE.Vector3(objectX, 0.22, -0.16),
          new THREE.Vector3(objectX, 0.22, 0.16),
        ]
      : [
          new THREE.Vector3(-3.35, 0.35, -0.14),
          new THREE.Vector3(-3.35, -0.35, 0.14),
        ];
  rayStarts.forEach((start, index) => {
    const objPoint =
      mode === "microscope"
        ? start
        : new THREE.Vector3(objectiveX, index === 0 ? 0.05 : -0.05, start.z);
    root.add(
      tube(
        [
          start,
  ...
  focalMarks.forEach((mark) => {
    addMarker(
      root,
      new THREE.Vector3(clamp(mark.x, -3.1, 3.1), -0.84, 0),
      mark.color,
    );
    root.add(
      label(
        mark.text,
        new THREE.Vector3(clamp(mark.x, -3.1, 3.1) - 0.2, -0.48, 0.12),
        mark.color,
      ),
    );
  });
  root.add(
    label("objective", new THREE.Vector3(objectiveX - 0.48, 1.22, 0), 0x67e8f9),
  );
  root.add(
    label("eyepiece", new THREE.Vector3(eyepieceX - 0.42, 1.12, 0), 0xa78bfa),
  );
  root.add(
    label(
      "intermediate image",
      new THREE.Vector3(intermediateX - 0.55, 0.62, 0),
      0x34d399,
    ),
  );
  root.add(
    label(
      "final virtual image direction",
      new THREE.Vector3(1.62, -1.18, 0.2),
      0xfde047,
    ),
  );
  root.add(
    label(
      `${mode} M ${magnification.toFixed(1)}x`,
      new THREE.Vector3(-2.92, -1.18, 0.2),
      0xfacc15,
    ),
  );
  root.add(
    label(
      "thin lens/paraxial rays",
      new THREE.Vector3(-0.82, 1.42, 0.2),
      0xe2e8f0,
    ),
  );
}
...
function buildWaveLab3D(
  root: THREE.Group,
  frequencyInput: number,
  amplitudeInput: number,
  mediumInput: number,
) {
  addPlatform(root);
  ...
  root.add(
    line(
      [
        new THREE.Vector3(-3.25, -0.35, -0.18),
        new THREE.Vector3(3.25, -0.35, -0.18),
      ],
      0x64748b,
      0.72,
  ...
  root.add(
    tube(
      [
        new THREE.Vector3(-2.7, -0.35, 0.22),
        new THREE.Vector3(-2.7, -0.35 + amplitude, 0.22),
      ],
      0.014,
      0xf43f5e,
      0.9,
  ...
  root.add(
    tube(
      [
        new THREE.Vector3(-1.15, -1.02, 0.15),
        new THREE.Vector3(-1.15 + wavelength, -1.02, 0.15),
      ],
      0.014,
      0x34d399,
      0.9,
  ...
  addArrow(
    root,
    new THREE.Vector3(2.0, 0.88, 0),
    new THREE.Vector3(3.0, 0.88, 0),
    0xfacc15,
  );
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(0.92, 1.2, 0.15),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `v=f lambda ${(frequency * wavelength).toFixed(1)}`,
      new THREE.Vector3(1.75, -1.22, 0.2),
      0xfacc15,
    ),
  );
  root.add(
    label(
      "medium particles oscillate locally",
      new THREE.Vector3(-2.88, 1.2, 0.15),
      0xe2e8f0,
    ),
  );
  root.add(
    label(
      mediumInput > 0 ? "uniform medium" : "linear wave model",
      new THREE.Vector3(-0.62, -1.48, 0.2),
      0x94a3b8,
    ),
  );
}

function buildChladni3D(
  root: THREE.Group,
  modeInput: number,
  frequencyInput: number,
  _unused = 0,
  ...
  const mode = Math.max(
    1,
    Math.round(clamp(modeInput || frequencyInput || 3, 1, 7)),
  );
  ...
  for (let index = 1; index <= mode; index += 1) {
    ...
    root.add(
      tube(
        [new THREE.Vector3(x, -0.34, -1.48), new THREE.Vector3(x, -0.34, 1.48)],
        0.012,
        0x22d3ee,
        0.8,
      ),
  ...
  for (let index = 1; index <= Math.max(1, Math.floor(mode / 2)); index += 1) {
    ...
    root.add(
      tube(
        [new THREE.Vector3(-1.48, -0.33, z), new THREE.Vector3(1.48, -0.33, z)],
        0.012,
        0x67e8f9,
        0.8,
      ),
  ...
  root.add(
    label("sand accumulation", new THREE.Vector3(0.8, 0.92, -1.4), 0xfacc15),
  );
  root.add(
    label(
      "antinode regions vibrate",
      new THREE.Vector3(-2.8, -1.18, 0.2),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      "illustrative nodal pattern",
      new THREE.Vector3(0.8, -1.18, 0.2),
      0xe2e8f0,
    ),
  );
}

function buildEcho3D(
  root: THREE.Group,
  timeInput: number,
  speedInput: number,
  distanceInput: number,
  ...
  root.add(wall);
  const outgoing = [
    new THREE.Vector3(-2.55, -0.25, -0.1),
    new THREE.Vector3(-0.3, 0.25, 0),
    new THREE.Vector3(2.45, -0.25, 0.1),
  ];
  const returning = [
    new THREE.Vector3(2.45, -0.52, -0.15),
    new THREE.Vector3(-0.2, -0.88, 0),
    new THREE.Vector3(-2.55, -0.52, 0.15),
  ];
  ...
  root.add(
    label("reflected pulse", new THREE.Vector3(-1.55, -1.22, 0.2), 0xfacc15),
  );
  root.add(label("reflecting wall", new THREE.Vector3(1.7, 1.18, 0), 0xe2e8f0));
  root.add(
    label(
      `echo time ${echoTime.toFixed(2)} s`,
      new THREE.Vector3(-2.95, 1.28, 0),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `distance ${(distanceInput || distance).toFixed(0)} m = v t / 2`,
      new THREE.Vector3(0.2, -1.28, 0.2),
      0x34d399,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(0.72, 1.28, 0),
      0xfacc15,
    ),
  );
}

function buildSoundPitch3D(
  root: THREE.Group,
  frequencyInput: number,
  amplitudeInput: number,
  distanceInput: number,
  ...
  for (let index = 0; index < 7; index += 1) {
    const ringWave = ring(
      0.35 + index * clamp(wavelength, 0.24, 0.68),
      0x22d3ee,
    );
  ...
  root.add(
    label(
      `pitch = frequency ${frequency.toFixed(0)} Hz`,
      new THREE.Vector3(-2.95, 1.3, 0),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      `loudness cue = amplitude ${amplitude.toFixed(1)}`,
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(1.1, -1.24, 0.2),
      0x34d399,
    ),
  );
  root.add(
    label(
      "simplified hearing model",
      new THREE.Vector3(-2.6, -1.22, 0.2),
      0xe2e8f0,
    ),
  );
  root.add(
    label(
      `distance ${distanceInput.toFixed(1)}`,
...
function buildSpringShm3D(
  ...
  root.add(
    tube(
      [
        new THREE.Vector3(0.85 - amplitude, -1.08, 0.2),
        new THREE.Vector3(0.85 + amplitude, -1.08, 0.2),
      ],
      0.014,
      0xf43f5e,
  ...
  addArrow(
    root,
    new THREE.Vector3(1.75, -0.28, 0.35),
    new THREE.Vector3(0.95, -0.28, 0.35),
    0xf43f5e,
  );
  addArrow(
    root,
    new THREE.Vector3(0.6, 0.2, 0.35),
    new THREE.Vector3(1.25, 0.2, 0.35),
    0x22d3ee,
  );
  ...
  root.add(
    label("amplitude endpoints", new THREE.Vector3(-0.42, 1.12, 0), 0xf43f5e),
  );
  root.add(
    label(
      "restoring force F=-kx",
      new THREE.Vector3(0.82, 0.78, 0.25),
      0xf43f5e,
    ),
  );
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(-2.72, 1.18, 0),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      "ideal spring / no damping",
      new THREE.Vector3(1.55, -1.26, 0.25),
      0xe2e8f0,
    ),
  );
}
...
function buildSpectrum3D(
  ...
  bands.forEach(([name, color], index) => {
    ...
    root.add(
      label(
        name,
        new THREE.Vector3(-3.35 + index, 0.35 + index * 0.04, 0.12),
        color,
      ),
    );
    const sample = sineWave(
      0.68,
      -0.05,
      clamp(0.16 - index * 0.015, 0.04, 0.16),
      color,
    );
  ...
  const markerIndex = clamp(
    ((Math.log10(Math.max(0.001, frequencyInput || markerInput || 1)) + 3) /
      6) *
      6,
    0,
    6,
  ...
  addArrow(
    root,
    new THREE.Vector3(-3 + markerIndex, 1.3, 0),
    new THREE.Vector3(-3 + markerIndex, 0.78, 0),
    0xfacc15,
  );
  root.add(
    tube(
      [new THREE.Vector3(-3.28, -1.12, 0), new THREE.Vector3(3.28, -1.12, 0)],
      0.015,
      0x94a3b8,
      0.8,
    ),
  ...
  addArrow(
    root,
    new THREE.Vector3(-2.65, -1.36, 0),
    new THREE.Vector3(2.85, -1.36, 0),
    0x67e8f9,
  );
  addArrow(
    root,
    new THREE.Vector3(2.85, -1.55, 0),
    new THREE.Vector3(-2.65, -1.55, 0),
    0xfacc15,
  );
  root.add(
    label("frequency increases", new THREE.Vector3(0.75, -1.28, 0.2), 0x67e8f9),
  );
  root.add(
    label(
      "wavelength decreases",
      new THREE.Vector3(-1.28, -1.58, 0.2),
      0xfacc15,
    ),
  );
  ...
  root.add(
    label(
      "qualitative boundaries / not to scale",
      new THREE.Vector3(-2.85, 1.22, 0),
      0x94a3b8,
    ),
  );
}

function buildPolarization3D(
  root: THREE.Group,
  ...
  const transmitted =
    i0 * Math.cos(theta) ** 2 * clamp(scaleInput || 1, 0.1, 1.5);
  root.add(
    tube(
      [new THREE.Vector3(-3.15, -0.05, 0), new THREE.Vector3(-1.4, -0.05, 0)],
      0.025,
      0xfde047,
      0.92,
    ),
  ...
  root.add(
    tube(
      [new THREE.Vector3(-1.12, -0.72, 0), new THREE.Vector3(-1.12, 0.72, 0)],
      0.012,
      0x67e8f9,
      0.9,
    ),
  ...
  root.add(
    tube(
      [
        ...
        new THREE.Vector3(0.88, 0.72 * Math.cos(theta), 0.72 * Math.sin(theta)),
      ],
      0.012,
      0xa78bfa,
      0.9,
  ...
  for (let index = 0; index < 6; index += 1) {
    const field = sineWave(
      0.7,
      0.78 - index * 0.08,
      0.12,
      index < 3 ? 0xfde047 : 0x34d399,
    );
  ...
  const meter = box(
    0.42,
    clamp(transmitted / 70, 0.08, 1.25),
    0.18,
    0x34d399,
    0.86,
  );
  ...
  root.add(meter);
  root.add(
    angleArc3D(new THREE.Vector3(0.1, -0.05, 0.28), 0.45, 0, theta, 0xfacc15),
  );
  ...
  root.add(
    label("transmission axis", new THREE.Vector3(-0.95, -1.22, 0.2), 0xe2e8f0),
  );
  root.add(
    label(
      `theta ${THREE.MathUtils.radToDeg(theta).toFixed(0)} deg`,
      new THREE.Vector3(0.1, 0.58, 0.45),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `I = I0 cos^2 theta = ${transmitted.toFixed(1)}`,
      new THREE.Vector3(1.25, -1.22, 0.25),
      0x34d399,
    ),
  );
  root.add(
    label(
      "ideal polarizers / Malus law",
      new THREE.Vector3(-2.85, -1.22, 0.25),
      0x94a3b8,
    ),
  );
}

function buildInterference(
  root: THREE.Group,
  frequency: number,
  amplitude: number,
  _unused = 0,
  ...
  for (let index = 0; index < 9; index += 1) {
    const fringe = box(
      0.08,
      0.16 + Math.abs(Math.sin(index)) * clamp(amplitude, 0.2, 1.8),
      1.25,
      index % 2 ? 0x334155 : 0xfacc15,
      index % 2 ? 0.35 : 0.78,
    );
...
function buildMeasurement3D(
  root: THREE.Group,
  readingInput: number,
  leastCountInput: number,
  trueValueInput: number,
) {
  addPlatform(root);
  ...
  addArrow(
    root,
    new THREE.Vector3(pointerX, 0.4, 0.2),
    new THREE.Vector3(pointerX, -0.42, 0.2),
    0xfacc15,
  );
  [-2, -1, 0, 1, 2].forEach((offset, index) => {
    ...
    addMarker(
      root,
      new THREE.Vector3(markerX, -0.34, 0.58),
      index === 2 ? 0xfacc15 : 0x22d3ee,
    );
  });
  ...
  root.add(
    tube(
      [
        new THREE.Vector3(trueX, -1.08, 0.5),
        new THREE.Vector3(pointerX, -1.08, 0.5),
      ],
      0.012,
      0xf43f5e,
      0.9,
  ...
  root.add(
    label(
      ...
      new THREE.Vector3(pointerX - 0.5, 0.72, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label(
      `least count ${leastCount.toFixed(3)}`,
      new THREE.Vector3(-2.75, 0.95, 0),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(0.55, -1.28, 0.45),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      "mean marker / repeated readings",
      new THREE.Vector3(-1.25, 1.25, 0.15),
      0x22d3ee,
    ),
  );
  root.add(
    label(
      "illustrative measurement model",
      new THREE.Vector3(1.25, 1.25, 0.15),
      0xe2e8f0,
    ),
  );
  root.add(
    label("zero error ignored", new THREE.Vector3(1.7, -1.28, 0.25), 0x94a3b8),
  );
}

function buildNuclearDecay3D(
  root: THREE.Group,
  initialInput: number,
  halfLifeInput: number,
  timeInput: number,
) {
  addPlatform(root);
  ...
  for (let index = 0; index < count; index += 1) {
    ...
    const nucleus = sphere(
      0.07,
      alive ? 0x22d3ee : 0xf43f5e,
      alive ? 0.9 : 0.58,
    );
    nucleus.position.set(
      -1.55 + (index % 8) * 0.42,
      -0.68 + Math.floor(index / 8) * 0.22,
      -0.82 + (index % 4) * 0.28,
    );
  ...
  root.add(
    label(
      `remaining ${Math.round(initial * remainingFraction)}`,
      new THREE.Vector3(-2.85, 1.32, 0),
      0x22d3ee,
    ),
  );
  root.add(
    label(
      `decayed ${Math.round(initial * (1 - remainingFraction))}`,
      new THREE.Vector3(-0.9, 1.32, 0),
      0xf43f5e,
    ),
  );
  root.add(
    label(
      `T1/2 ${halfLife.toFixed(1)}`,
      new THREE.Vector3(-2.55, -1.24, 0.25),
      0xfacc15,
    ),
  );
  root.add(
    label("random decay model", new THREE.Vector3(0.75, 1.32, 0), 0xe2e8f0),
  );
  root.add(
    label(
      "statistical, not individual prediction",
      new THREE.Vector3(0.7, -1.24, 0.25),
      0x94a3b8,
    ),
  );
}

function buildDiode3D(
  root: THREE.Group,
  voltageInput: number,
  ...
  for (let index = 0; index < 18; index += 1) {
    ...
    carrier.position.set(
      -1.35 + (index % 9) * 0.34,
      -0.62 + Math.floor(index / 9) * 0.62,
      ((index * 17) % 80) / 100 - 0.4,
    );
    if (conducts) {
      carrier.userData.role = "path";
      carrier.userData.path = [
        carrier.position.clone(),
        carrier.position.clone().add(new THREE.Vector3(2.4, 0, 0)),
      ];
  ...
  addArrow(
    root,
    new THREE.Vector3(-2.3, 0.95, 0),
    new THREE.Vector3(2.3, 0.95, 0),
    conducts ? 0x34d399 : 0x64748b,
  );
  ...
  root.add(
    label("depletion region", new THREE.Vector3(-0.72, -1.22, 0.2), 0xfacc15),
  );
  root.add(
    label(
      conducts ? "forward bias current" : "reverse/blocking bias",
      new THREE.Vector3(0.78, 1.32, 0),
      conducts ? 0x34d399 : 0xf43f5e,
    ),
  );
  root.add(
    label(
      "simplified PN junction",
      new THREE.Vector3(0.92, -1.22, 0.2),
      0xe2e8f0,
    ),
  );
}

function buildEnergySources3D(
  root: THREE.Group,
  ...
  sources.forEach((source, index) => {
    ...
    const base = box(
      ...
      0.08,
      0.82,
      selected === index ? 0xfacc15 : 0x334155,
      selected === index ? 0.82 : 0.55,
    );
    base.position.set(x, -0.95, 0);
    root.add(base);
    const icon =
      index === 1
        ? cylinder(0.05, 0.05, 0.8, source.color, 0.9)
        : index === 0
          ? box(0.65, 0.08, 0.42, source.color, 0.86)
          : index === 2
            ? box(0.72, 0.38, 0.24, source.color, 0.7)
            : cylinder(0.25, 0.33, 0.55, source.color, 0.72);
    icon.position.set(x, -0.55, 0);
    if (index === 1) icon.rotation.z = Math.PI / 2;
    root.add(icon);
    const output = box(
      0.16,
      clamp(source.output + outputInput / 200, 0.18, 1.25),
      0.16,
      0x34d399,
      0.86,
    );
    output.position.set(
      x - 0.25,
      -0.95 + output.geometry.parameters.height / 2,
      0.48,
    );
    const emissions = box(
      0.16,
      clamp(source.emissions + emissionInput / 200, 0.08, 1.25),
      0.16,
      0xf43f5e,
      0.72,
    );
    emissions.position.set(
      x + 0.25,
      -0.95 + emissions.geometry.parameters.height / 2,
      0.48,
    );
    root.add(output, emissions);
    root.add(
      label(source.name, new THREE.Vector3(x - 0.45, 0.28, 0), source.color),
    );
  });
  root.add(label("output bars", new THREE.Vector3(-2.95, 1.2, 0), 0x34d399));
  root.add(
    label("emissions/limits", new THREE.Vector3(-0.85, 1.2, 0), 0xf43f5e),
  );
  root.add(
    label(
      "illustrative comparison data",
      new THREE.Vector3(1.1, 1.2, 0),
      0xe2e8f0,
    ),
  );
}

function buildQuantumOperators3D(
  root: THREE.Group,
  stateInput: number,
  operatorInput: number,
  measurementInput: number,
) {
  addPlatform(root);
  const stateAngle = THREE.MathUtils.degToRad(
    clamp(stateInput || 45, 0, 100) * 1.4 + 15,
  );
  const operatorAngle = THREE.MathUtils.degToRad(
    clamp(operatorInput || 50, 0, 100) * 1.2 + 10,
  );
  ...
  addArrow(
    ...
    new THREE.Vector3(
      -1.2 + Math.cos(stateAngle),
      -0.1 + Math.sin(stateAngle),
      0.25,
    ),
    0x22d3ee,
  );
  addArrow(
    ...
    new THREE.Vector3(-1.2, -0.1, 0),
    new THREE.Vector3(
      -1.2 + Math.cos(operatorAngle) * 1.1,
      -0.1 + Math.sin(operatorAngle) * 1.1,
      -0.1,
    ),
    0xfacc15,
  );
  ...
  root.add(matrix);
  root.add(
    label("state vector |psi>", new THREE.Vector3(-2.75, 1.22, 0), 0x22d3ee),
  );
  root.add(label("operator A", new THREE.Vector3(-1.0, 1.22, 0), 0xfacc15));
  root.add(
    label(
      `eigenvalue cue ${measurementInput.toFixed(1)}`,
      new THREE.Vector3(0.8, 1.22, 0),
      0xe2e8f0,
    ),
  );
  root.add(
    label(
      `expectation ${(projection * 100).toFixed(0)}%`,
      new THREE.Vector3(1.1, -1.22, 0.2),
      0x34d399,
    ),
  );
  root.add(
    label(
      "qualitative quantum visualization",
      new THREE.Vector3(-2.8, -1.22, 0.2),
      0x94a3b8,
    ),
  );
}

function buildComputationalWorkflow3D(
  root: THREE.Group,
  stepInput: number,
  iterationInput: number,
  errorInput: number,
) {
  addPlatform(root);
  const iterations = Math.round(clamp(iterationInput || 12, 3, 40));
  const error = clamp(
    errorInput || Math.exp(-iterations / 8) * clamp(stepInput || 0.1, 0.01, 1),
    0.001,
    1,
  );
  ...
  names.forEach((name, index) => {
    const node = box(
      ...
      0.42,
      0.55,
      index < 2 ? 0x22d3ee : index < 4 ? 0xfacc15 : 0x34d399,
      0.72,
    );
    ...
    if (index < names.length - 1)
      addArrow(
        root,
        new THREE.Vector3(-2.18 + index * 1.3, -0.42, 0),
        new THREE.Vector3(-1.72 + index * 1.3, -0.42, 0),
        0x94a3b8,
      );
    root.add(
      label(name, new THREE.Vector3(-2.95 + index * 1.3, 0.08, 0.1), 0xe2e8f0),
    );
  });
  for (let index = 0; index < 6; index += 1) {
    root.add(
      line(
        [
          new THREE.Vector3(-2.2 + index * 0.16, -0.92, -0.55),
          new THREE.Vector3(-2.2 + index * 0.16, -0.92, 0.55),
        ],
        0x334155,
        0.72,
    ...
    root.add(
      line(
        [
          new THREE.Vector3(-2.25, -0.92, -0.5 + index * 0.2),
          new THREE.Vector3(-1.35, -0.92, -0.5 + index * 0.2),
        ],
        0x334155,
        0.72,
      ),
  ...
  root.add(
    label(
      "discretization mesh",
      new THREE.Vector3(-2.78, -1.22, 0.25),
      0x67e8f9,
    ),
  );
  root.add(
    label(
      ...
      new THREE.Vector3(0.55, -1.22, 0.25),
      0xe2e8f0,
    ),
  );
}

function buildPhotoelectric(
  root: THREE.Group,
  photonEnergy: number,
  workFunction: number,
  _unused = 0,
...
function buildBohr(root: THREE.Group, n1: number, n2: number, _unused = 0) {
  ...
  [1, 2, 3, 4, 5].forEach((level) => {
    const shell = ring(
      0.42 + level * 0.28,
      level === final ? 0x22d3ee : level === initial ? 0xfacc15 : 0x475569,
    );
  ...
  const transition = tube(
    ...
    0.012,
    final < initial ? 0xfacc15 : 0x38bdf8,
    0.8,
  );
  ...
  const photon = tube(
    [
      ...
      new THREE.Vector3(-1.55, 1.05, 0.15),
      new THREE.Vector3(-0.65, 1.22, -0.1),
    ],
    0.018,
    photonColor,
    0.95,
  ...
  for (let index = 1; index <= 5; index += 1) {
    ...
    const bar = box(
      ...
      0.035,
      0.035,
      index === final ? 0x22d3ee : index === initial ? 0xfacc15 : 0x64748b,
      0.85,
    );
    ...
    root.add(
      label(
        `n=${index}`,
        new THREE.Vector3(2.45, -0.95 + height * 1.9, 0),
        index === final ? 0x22d3ee : 0x94a3b8,
      ),
    );
  }
  root.add(
    label(
      final < initial ? "emission" : final > initial ? "absorption" : "no jump",
      new THREE.Vector3(-2.52, 1.72, 0),
      photonColor,
    ),
  );
...
function buildCoupledOscillator(
  root: THREE.Group,
  angle1: number,
  angle2: number,
  coupling: number,
  ...
  const theta2 = THREE.MathUtils.degToRad(
    clamp(angle2 + coupling * 38, 5, 112),
  );
  ...
  const joint = new THREE.Vector3(
    pivot.x + Math.sin(theta1) * l1,
    pivot.y - Math.cos(theta1) * l1,
    0,
  );
  const bob = new THREE.Vector3(
    joint.x + Math.sin(theta2) * l2,
    joint.y - Math.cos(theta2) * l2,
    0.18,
  );
  ...
  const pathPoints = Array.from({ length: 160 }, (_, index) => {
    const t = index / 16;
    const spread =
      0.7 + couplingStrength * 1.65 + Math.max(0, angle1 + angle2 - 90) * 0.018;
    return new THREE.Vector3(
  ...
  root.add(trail);
  const regularLoop = tube(
    Array.from({ length: 96 }, (_, index) => {
      const t = (index / 95) * Math.PI * 2;
      return new THREE.Vector3(
        1.45 + Math.cos(t) * 0.72,
        -0.15 + Math.sin(t) * 0.38,
        -0.95,
      );
    }),
    0.01,
  ...
  root.add(
    line(
      [new THREE.Vector3(0, -1, -0.34), new THREE.Vector3(2.9, -1, -0.34)],
      0x475569,
      0.85,
    ),
  );
  root.add(
    line(
      [
        new THREE.Vector3(1.45, -1.85, -0.34),
        new THREE.Vector3(1.45, -0.2, -0.34),
      ],
      0x475569,
      0.85,
    ),
  ...
  root.add(
    label("double pendulum", new THREE.Vector3(-2.65, 1.55, 0), 0x67e8f9),
  );
  root.add(label("phase trail", new THREE.Vector3(1.95, 1.2, -0.2), 0xf43f5e));
  root.add(
    label(
      couplingStrength > 0.58 ? "sensitive divergence" : "regular beating",
      new THREE.Vector3(0.55, -1.75, -0.3),
      couplingStrength > 0.58 ? 0xf43f5e : 0x22d3ee,
    ),
  );

  const energyA = box(
    0.18,
    clamp(0.35 + angle1 / 80, 0.35, 1.35),
    0.18,
    0x22d3ee,
    0.82,
  );
  ...
  const energyB = box(
    0.18,
    clamp(0.35 + angle2 / 80, 0.35, 1.35),
    0.18,
    0xf43f5e,
    0.82,
  );
...
function buildLogic(
  ...
  [-0.45, 0.45].forEach((y, index) => {
    root.add(
      line(
        [new THREE.Vector3(-2.8, y, 0), new THREE.Vector3(-0.6, y, 0)],
        index === 0
          ? inputA >= 0.5
            ? 0x34d399
            : 0x475569
  ...
  root.add(
    line(
      [new THREE.Vector3(0.6, 0, 0), new THREE.Vector3(2.5, 0, 0)],
      active ? 0x34d399 : 0x475569,
    ),
  );
...
function updateObjects(
  ...
  root.traverse((object) => {
    ...
    if (object.userData.role === "path") {
      ...
      const offset =
        typeof object.userData.offset === "number" ? object.userData.offset : 0;
      object.position.copy(samplePath(path, (offset + t * 0.22) % 1));
    }
    if (object.userData.role === "cart")
      object.position.x = -0.8 + Math.sin(t * 1.6) * 0.12;
    if (object.userData.role === "force-balance")
      object.position.x =
        Math.sin(t * 1.45) *
        0.11 *
        object.userData.power *
    ...
    if (object.userData.role === "incline-block") {
      ...
      object.position.copy(
        pointOnIncline(rampCenter, tangent, normal, alongRamp, clearance),
      );
    }
    ...
    if (object.userData.role === "coupled-joint") {
      ...
      const theta =
        Math.sin(t * (1.05 + chaos * 0.55)) * amp1 +
        Math.sin(t * 2.1) * chaos * 0.22;
      const pivot = object.userData.pivot as THREE.Vector3;
      const length = object.userData.length as number;
      object.position.set(
        pivot.x + Math.sin(theta) * length,
        pivot.y - Math.cos(theta) * length,
        Math.sin(t * 0.7) * 0.12,
      );
    }
    if (object.userData.role === "coupled-bob") {
      ...
      const theta1 =
        ...
        Math.sin(t * 2.1) * chaos * 0.22;
      const theta2 =
        Math.sin(t * (1.75 + chaos * 0.9) + Math.sin(t * 0.41) * chaos * 2.1) *
        amp2;
      const pivot = object.userData.pivot as THREE.Vector3;
    ...
    if (object.userData.role === "orbit") {
      ...
      const jump = object.userData.finalRadius
        ? (Math.sin(t * 1.1) + 1) / 2
        : 0;
      ...
      object.position.set(
        ...
        -0.55 + Math.sin(phase * 0.5) * 0.14,
        Math.sin(phase) * radius,
      );
    }
    if (object.userData.role === "float")
      object.position.y += Math.sin(t * 2.1) * 0.003;
    if (object.userData.role === "water")
      object.scale.y = 1 + Math.sin(t * 1.6) * 0.025;
    ...
    if (object.userData.role === "charge")
      object.position.copy(
        samplePath(
          object.userData.path,
          (object.userData.offset + t * 0.08 * object.userData.speed) % 1,
        ),
      );
    ...
    if (object.userData.role === "field")
      object.scale.setScalar(
        1 +
          Math.sin(t * 2.5 + object.userData.phase) *
            0.08 *
            object.userData.power,
      );
    if (object.userData.role === "magnet")
      object.position.x = -1.8 + ((Math.sin(t * 1.5) + 1) / 2) * 3.6;
    if (object.userData.role === "needle")
      object.rotation.z = Math.sin(t * 2.1) * object.userData.power;
    if (object.userData.role === "spin")
      object.rotation.y = t * object.userData.speed;
    if (object.userData.role === "wave-shift")
      object.position.x = Math.sin(t * object.userData.speed) * 0.12;
    if (object.userData.role === "wave")
      object.scale.setScalar(
        0.82 + ((t * object.userData.speed + object.userData.phase) % 1) * 0.45,
      );
    if (object.userData.role === "pulse")
      object.scale.setScalar(1 + Math.sin(t * 4) * 0.12);
    ...
    if (object.userData.role === "ambient-spark") {
      ...
      object.position.x +=
        Math.cos(t * object.userData.speed * 0.7 + seed) * 0.003;
      const mesh = object as THREE.Mesh;
    ...
    if (object.userData.role === "beacon") {
      ...
      mesh.scale.setScalar(
        1 + Math.sin(t * 3.4) * 0.25 * object.userData.power,
      );
    }
    if (object.userData.role === "photon")
      object.position.set(
        -3 + ((object.userData.offset + t * 0.45) % 1) * 2.15,
        0.62 - object.userData.offset * 0.32,
        0,
      );
    if (object.userData.role === "electron")
      object.position.set(
        -0.35 + ((object.userData.offset + t * 0.32) % 1) * 2.65,
        -0.6 + object.userData.offset * 0.38,
        0.25,
      );
  });
  root.position.y = Math.sin(t * 0.7) * 0.035;
  const hasInclineBlock = root.userData.hasInclineBlock === true;
  if (!hasInclineBlock && values[2] > 50)
...
function pointOnIncline(
  ...
  return center
    .clone()
    .addScaledVector(tangent, alongRamp)
...
function ring(radius: number, color: number) {
  ...
  const points = curve
    ...
    .map(
      (point) =>
        new THREE.Vector3(point.x, point.y - 0.72, point.y === point.y ? 0 : 0),
    );
...
function sineWave(width: number, y: number, amp: number, color: number) {
  return line(
    Array.from({ length: 80 }, (_, index) => {
      ...
      return new THREE.Vector3(
        -width / 2 + width * u,
        -1.25 + y + Math.sin(u * Math.PI * 4) * amp,
        -1.3,
      );
    }),
    color,
