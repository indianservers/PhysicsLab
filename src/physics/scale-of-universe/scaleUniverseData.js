...
const baseScaleUniverseObjects = [
  ...
  item("electron", "Electron", "Subatomic Particle", 1e-18, 180, -70, 10, "An electron is a tiny negatively charged particle with no measured internal size.", ["In the Standard Model it is treated as point-like.", "Scattering experiments constrain any radius to far below atomic size.", "Electric current is often electron motion."], "<~10^-18 m experimental scale", "particle", "#ffd60a"),
  ...
  item("solar-system", "Planetary Solar System", "Solar System", 9e12, -280, 60, 10, "The main planetary Solar System is roughly measured by Neptune's orbital diameter.", ["This is not the full Oort Cloud extent.", "Distances are often measured in astronomical units.", "The Sun is the central mass."], "~9 x 10^12 m across Neptune's orbit", "lineDistance", "#fde68a"),
...
const supplementalSpecs = [
  ...
  ["neptune-orbit", "Neptune Orbit Diameter", "Astronomical Distance", 9e12, "Distances", 8, "The approximate diameter of Neptune's orbit around the Sun.", "9 x 10^12 m across"],
  ["oort-cloud", "Oort Cloud Outer Radius", "Astronomical Distance", 1.5e16, "Distances", 8, "A distant icy reservoir extending far beyond the planets.", "outer radius ~1.5 x 10^16 m"],
