...
export const circularMotionPresets: ControlPreset[] = [
  {
    id: "benchmark",
    label: "Benchmark",
    values: { mass: 2, radius: 3, omega: 4 },
  },
  {
    id: "fast-small",
    label: "Fast small circle",
    values: { mass: 1, radius: 1.5, omega: 6 },
  },
  {
    id: "wide-slow",
    label: "Wide slow circle",
    values: { mass: 3, radius: 5, omega: 2 },
  },
];

export function circularMotionControls(
  values: typeof circularMotionDefaults,
  simple: boolean,
): ExperimentControl[] {
  const controls: ExperimentControl[] = [
    {
      ...
      step: 0.1,
      value: values.omega,
      defaultValue: circularMotionDefaults.omega,
    },
    {
      id: "mass",
      label: "Mass",
      ...
      step: 0.1,
      value: values.mass,
      defaultValue: circularMotionDefaults.mass,
    },
    {
      id: "radius",
      label: "Radius",
      ...
      step: 0.1,
      value: values.radius,
      defaultValue: circularMotionDefaults.radius,
    },
  ];
  return simple
    ? controls.filter((control) => control.id === "omega")
    : controls;
}
