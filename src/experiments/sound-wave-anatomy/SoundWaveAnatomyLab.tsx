...
export function SoundWaveAnatomyLab(props: DedicatedExperimentLabProps) {
  return <PremiumWaveLab experiment={props.experiment} config={premiumWaveConfigs["sound-wave-anatomy"]} mode={resolveMode(props)} />;
}
