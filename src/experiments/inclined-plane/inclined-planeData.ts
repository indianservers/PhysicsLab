...
export const inclinedPlaneDefaults = {
  angle: 30,
  mass: 5,
  mu: 0.2,
  gravity: 9.8,
...
export const inclinedPlanePresets: ControlPreset[] = [
  {
    id: "frictionless-30",
    label: "30° no friction",
    values: { angle: 30, mu: 0 },
  },
  { id: "flat", label: "Flat plane", values: { angle: 0, mu: 0.2 } },
  { id: "steep", label: "Steep slide", values: { angle: 55, mu: 0.1 } },
];

export function inclinedPlaneControls(
  values: typeof inclinedPlaneDefaults,
  simple: boolean,
): ExperimentControl[] {
  const controls: ExperimentControl[] = [
    {
      ...
      step: 1,
      value: values.angle,
      defaultValue: inclinedPlaneDefaults.angle,
    },
    {
      id: "mass",
      label: "Mass",
      ...
      step: 0.5,
      value: values.mass,
      defaultValue: inclinedPlaneDefaults.mass,
    },
    {
      id: "mu",
      ...
      step: 0.01,
      value: values.mu,
      defaultValue: inclinedPlaneDefaults.mu,
    },
    {
      id: "gravity",
      label: "Gravity",
      ...
      defaultValue: inclinedPlaneDefaults.gravity,
    },
  ];
  return simple
    ? controls.filter((control) => control.id === "angle")
    : controls;
}
