...
export function WaveLab(props: DedicatedExperimentLabProps) {
  return <PremiumWaveLab experiment={props.experiment} config={premiumWaveConfigs["wave-lab"]} mode={resolveMode(props)} />;
}
