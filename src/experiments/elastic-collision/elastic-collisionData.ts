...
export const elasticCollisionSymbols: FormulaSymbol[] = [
  ...
  {
    symbol: "v1, v2",
    meaning: "Final velocities after collision",
    unit: "m/s",
  },
];
...
export const elasticCollisionPresets: ControlPreset[] = [
  {
    ...
    values: { m1: 1, m2: 1, u1: 5, u2: 0 },
  },
  {
    id: "heavy-light",
    label: "Heavy into light",
    values: { m1: 2, m2: 1, u1: 3, u2: 0 },
  },
  {
    id: "head-on",
    label: "Head-on",
    values: { m1: 1.5, m2: 1, u1: 4, u2: -2 },
  },
];

export function elasticCollisionControls(
  values: typeof elasticCollisionDefaults,
  simple: boolean,
): ExperimentControl[] {
  const controls: ExperimentControl[] = [
    {
      ...
      step: 0.5,
      value: values.u1,
      defaultValue: elasticCollisionDefaults.u1,
    },
    {
      id: "m1",
      label: "Mass 1",
      ...
      step: 0.1,
      value: values.m1,
      defaultValue: elasticCollisionDefaults.m1,
    },
    {
      id: "m2",
      label: "Mass 2",
      ...
      step: 0.1,
      value: values.m2,
      defaultValue: elasticCollisionDefaults.m2,
    },
    {
      id: "u2",
      ...
      step: 0.5,
      value: values.u2,
      defaultValue: elasticCollisionDefaults.u2,
    },
  ];
