...
export const top30ExperimentRegistry: Record<string, Top30ExperimentMeta> = {
  ...
  "prism-dispersion": top30("prism-dispersion", "optics", "Prism darkroom with white beam, normals, split spectrum, material selector, and deviation angle.", opticsOverlays, "formula-only", "phase-5-optics-fluids-thermal", "Different wavelengths refract by different amounts."),
  ...
  "human-eye-defects": top30("human-eye-defects", "optics", "Eye focus simulator with retina, cornea/lens, myopia/hyperopia focus point, and corrective lens selector.", opticsOverlays, "qualitative-visual", "phase-5-optics-fluids-thermal", "Corrective lenses move focus back onto the retina."),
  ...
  "bernoulli-fluid-flow": top30("bernoulli-fluid-flow", "fluids", "Venturi pipe with streamlines, pressure probes, speed particles, and pressure-speed tradeoff graph.", fluidsOverlays, "formula-only", "phase-5-optics-fluids-thermal", "Faster flow corresponds to lower static pressure in the ideal model."),
